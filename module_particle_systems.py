...
particle_systems = [
    ...
    ("game_snow", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size|psf_randomize_rotation, "prt_mesh_snow_fall_1",
     ...
     0.5                        #rotation damping
	  ...
	  ("explosion", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size|psf_randomize_rotation, "prt_explosion",
     1, 2, 2, 0.1, 0, 0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.2, 1), (1, 1),        #alpha keys
     (1.0, 1.0), (1, 1.0),      #red keys
     (1.0, 1.0), (1, 1.0),      #green keys
     (1.0, 1.0), (1, 1.0),      #blue keys
     (1.0, 1.0),   (1.0, 1.0),   #scale keys
     (5, 5, 10),           #emit box size
     (0, 0, 0),               #emit velocity
...
##    
 ...
 #   ),
    ...
    ("war_smoke_tall", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_rotation|psf_randomize_size, "prt_mesh_smoke_1",
     ...
     2100, 0.9, 0, 0, 7, 7, #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0, 0.25), (1, 0),          #alpha keys
     (0.0, 1), (1, 0.8),      #red keys
     (0.0, 1),(1, 0.8),      #green keys
     (0.0, 1), (1, 0.8),     #blue keys
     ...
     2300, 0.9, 0, 0, 7, 7, #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0, 0.25), (1, 0),          #alpha keys
     (0.0, 1), (1, 0.8),      #red keys
     (0.0, 1),(1, 0.8),      #green keys
     (0.0, 1), (1, 0.8),     #blue keys
    ...
    ("pistol_smoke", psf_billboard_3d, "prtcl_dust_a",
     200, 5.5, 0.6, 0.0, 60.0, 1.5,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.0, 0.75), (1, 0),       #alpha keys
     (0.0, 0.7), (1, 0.4),      #red keys
     (0.0, 0.7),(1, 0.4),       #green keys
     (0.0, 0.7), (1, 0.4),      #blue keys
     (0, 3.0),   (1.0, 16.0),   #scale keys
     (0.1, 0.1, 0.1),           #emit box size
     (2, 2, 0),                 #emit velocity
     0.1                        #emit dir randomness
    ),
 	("musket_smoke", psf_billboard_3d, "prtcl_dust_a",
     200, 4.8, 0.6, 0.0, 30.0, 3.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.0, 0.75), (1, 0),       #alpha keys
     (0.0, 0.7), (1, 0.4),      #red keys
     (0.0, 0.7),(1, 0.4),       #green keys
     (0.0, 0.7), (1, 0.4),      #blue keys
     (0, 6.0),   (2.0, 23.0),   #scale keys
     (0.06, 0.06, 0.06),           #emit box size
     (0, 3, 0.1),                 #emit velocity
     0.1                        #emit dir randomness
    ),
	("musket_fire_sparks", psf_billboard_3d, "prt_mesh_fire_1",
     30, 0.1, 0.0, 0.0, 5.0, 0.3,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.5, 0.8), (1, 0),        #alpha keys
     (0.8, 1.0), (1, 0.9),      #red keys
     (0.5, 0.7),(1, 0.3),       #green keys
     (0.5, 0.2), (1, 0.0),      #blue keys
     (0, 0.03),   (0.8, 0.3),   #scale keys
     (0.1, 0.1, 0.1),           #emit box size
     (5, 5, 0),                 #emit velocity
     0.05                        #emit dir randomness
    ),
   ("cannon_fire_sparks", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size|psf_randomize_rotation, "prt_mesh_fire_1",
     50, 0.2, 0.0, 0.0, 8.0, 0.3,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.5, 0.8), (1, 0),        #alpha keys
     (0.8, 1.0), (1, 0.9),      #red keys
     (0.5, 0.7),(1, 0.3),       #green keys
     (0.5, 0.2), (1, 0.0),      #blue keys
     (0, 0.03),   (0.2, 0.8),   #scale keys
     (0.1, 0.1, 0.1),           #emit box size
     (5, 5, 0),                 #emit velocity
     0.05                        #emit dir randomness
    ),
	   ("musket_smoke2", psf_billboard_3d, "prtcl_new_musket",
     405, 2.5, 0.55, -0.5, 70.0, 1.75,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.0, 0.75), (1, 0.4),       #alpha keys
     (0.0, 0.7), (1, 0.4),      #red keys
     (0.0, 0.7),(1, 0.4),       #green keys
     (0.0, 0.7), (1, 0.4),      #blue keys
     (0, 2.0),   (0.5, 11.0),   #scale keys
     (0.1, 0.1, 0.1),           #emit box size
     (2, 3, 0),                 #emit velocity
     0.1                        #emit dir randomness
    ),
	("pistol_fire_sparks", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size|psf_randomize_rotation, "prt_mesh_fire_1",
     40, 0.1, 0.0, 0.0, 7.0, 0.3,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.5, 0.8), (1, 0),        #alpha keys
     (0.8, 1.0), (1, 0.9),      #red keys
     (0.5, 0.7),(1, 0.3),       #green keys
     (0.5, 0.2), (1, 0.0),      #blue keys
...
#-*-*-*- Moon Beam *-*-*-*-*-*-*#
  ...
  ("1794_fog", psf_billboard_2d|psf_global_emit_dir|psf_always_emit, "prtcl_dust_a",
     10, 50.2, 0.11, 0, 2.0, 0.6,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.8, 1.0), (1.0, 1.0), #alpha keys
     (0.1, 0.1), (0.1, 0.1), #red keys
     (0, 0.1), (1, 0.1), #green keys
     (0.1, 0.1), (0.1, 0.1), #blue keys
     (0, 0.30),   (0.6, 0.3), #scale keys
     (2.37, 5.37, 0.55),  #emit box size
     (0.1, 0.1, 0.0),           #emit velocity
...
#-*-*-*- Village Fire *-*-*-*-#
    ...
    ("map_village_fire", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size|psf_randomize_rotation, "prt_mesh_fire_1",
     30, 1.0, 0, -0.2, 3.0, 3.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.2, 0.7), (1, 0),        #alpha keys
     (0.2, 1.0), (1, 0.9),      #red keys
     (0.2, 0.7),(1, 0.3),       #green keys
     (0.2, 0.2), (1, 0.0),      #blue keys
    ...
    ("map_village_fire_smoke", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size|psf_randomize_rotation, "prt_mesh_smoke_1",
     35, 2.5, 0.3, -0.15, 3.0, 3.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.5, 0.15), (1, 0),       #alpha keys
    ...
    ("map_village_looted_smoke", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size|psf_randomize_rotation, "prt_mesh_smoke_1",
     30, 3, 0.3, -0.11, 3.0, 2.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.5, 0.15), (1, 0),       #alpha keys
