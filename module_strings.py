...
##  ("nothing", "nothing"),
  ...
  ("s50_and_s51", "{s50} i {s51}"),
  ("s52_comma_s51", "{!}{s52}, {s51}"),
  ("s52_and_s51", "{s52} i {s51}"),
  ("s5_s_party", "{s5}"),# Powinno być "Oddział Porucznika/Pułkownika

  ("given_by_s1_at_s2", "Dane przez: {s1} w: {s2}"),
  ("given_by_s1_in_wilderness", "Dane przez: {s1} w polu"),
  ("s7_raiders", "{s7} Najeźdźcy"),

  ("bandits_eliminated_by_another", "Kłopotliwi bandyci zostali wyeliminowani przez inny oddział."),
  ("msg_battle_won","Bitwa wygrana! Naciśnij klawisz Tab, aby wyjść..."),
  ("tutorial_map1","Znajdujesz się na mapie świata. Kliknij lewym przyciskiem na miejsce, aby przenieść w nie oddział, wejść do wybranego miasta lub ścigać wybrany oddział. Czas na mapie krainy nie będzie płynąć, jeśli oddział będzie stać w miejscu lub czekać. Naciśnij i przytrzymaj Spację, aby zaczekać w dowolnym miejscu."),
  ...
  ("hold_fire", "Wstrzymać ogień"),
  ("blunt_hold_fire", "Blunt / Hold Fire"),

####################################################################
### 1794 STRINGS
####################################################################
 ("1794_start_game", "Roku Pańskiego 1794 Europa po raz kolejny pogrążyła się w tumultach i niepokojach. Chwalebne zwycięstwa rewolucji Francuskiej i Amerykańskiej, potężny cios zadały autorytetowi absolutnej monarchii. Tak też i ucisk, w którym trzymała ona ludy, zelżał znacznie, co tyranów wnet w gniew wprawiło. Porzucając między sobą swary, monarchowie zjednoczyli się we wspólnym wysiłku, aby zdusić płomienie wolności rozpalone wskroś Starego Świata. Ich pierwszą ofiarą miała się stać Rzeczpospolita."),
 ("1794_start_game_a", "Niegdyś jedna z wielkich Europejskich potęg, Rzeczypospolita Obojga Narodów zasłynęła w świecie zaprowadzeniem światłych ideałów wolności i demokracji, stanowiąc wzorzec dla reszty ludzkości i szlak wyznaczając, którym ta podążać miała. Tyrani tedy, zgorzkniali i nienawistni, nie szczędzili wysiłków, by przyprowadzić ją ku upadkowi, a jej narody ku zgubie. Nim nastała wiosna rzeczonego roku 1794, powiodły się im te zamiary tak dalece, że niegdyś ogromne i potężne państwo obrócili w niwecz, czyniąc z niego swą marionetkę, a władzę sprawując rękoma zdrajców i łapówkarzy. A mimo to nie mogli spocząć ani spać spokojnie, jak długo ślad jakowy po minionej chwale się ostał."),
 
 ("1794_text_a", "Czarne chmury zbierały się nad Rzeczpospolitą, a tłumy poszukiwaczy przygód forsowały jej granice, szukając szansy na poprawę swego losu. Byliżby to weterani rewolucyjnych batalii, czy zwykłe kundle wojny, bohaterowie czy nicponie, wszystkich przepajało pragnienie by udział wziąć w nadchodzącej wojnie, po tej czy innej stronie. Pomiędzy nimi znalazł się i pewien wyjątkowy człowiek. O pochodzeniu jego nie wiemy wiele, wydaje się jednak, że pochodził z ziem z dawien przynależnych Rzeczpospolitej lub w przeszłości Jej zhołdowanych, to jest..."), 
 ("1794_text_a_opis_1", "... z terenów Korony, to jest Królestwa Polskiego. A twierdzę tak, albowiem żywot jego świadczył o głębokim umiłowaniu cnót takich jak wiara, honor i miłość ojczyzny. Niemałe miał mniemanie o sobie i zewsząd domagał się szacunku. Najbardziej cenił sobie jednak sztukę prowadzenia sporów, obracając zręcznie słowy, a jeśli trzeba było to i orężem właściwym. W takim to duchu młodzież się chowała na terenach prowincji: Małopolskiej, Wielkopolskiej i Mazowsza."),
 ("1794_text_a_opis_2", "... z terenów Litwy, to jest Wielkiego Księstwa Litewskiego. A twierdzę tak, albowiem był on duchem wolnym i niespokojnym, a ponad wszystko miłował dziki krajobraz Kresów. Gdziekolwiek się znalazł, żył w wielkiej harmonii z naturą i miał głębokie zrozumienie prawa przyrody. Nie widział świat większego poety, ni lepszego myśliwego. Pogodny i przyjazny z usposobienia, zawsze otoczony był przez przyjaciół gdziekolwiek się nie znalazł. Tacy to ludzie rodzili się na Litwie w owych czasach."),
 ("1794_text_a_opis_3", " ... to jest z terenów Rusi, przyłączonych do Rzeczpospolitej w jej złotym wieku. A twierdzę tak, albowiem był on człekiem gościnnym i życzliwym z natury, a z życia czerpał pełnymi garściami. Doświadczył licznych kaprysów losu i wyciągnął z tego naukę. Był przednim kompanem, zarówno w bitwie jak i za stołem biesiadnym, w gniewie zaś stawał się zapalczywy i nieubłagalny. Uwielbiał smak przygody i w przeszłości nieraz przemierzał bezkresne równiny, które słusznie wzbudzają zachwyty poetów."),
 ("1794_text_a_opis_4", "... to jest z ziem obrzeżnych, które z Rzeczpospolitą bliskie miały związki na mocy unii, hołdów i przymierzy. A twierdzę tak, albowiem był on człowiekiem chłodnym i kalkulującym, a jednak pożądanym w towarzystwie ze względu na liczne talenty. Miał on głębokie pojęcie na temat rozmaitych nauk i rzemiosła, artylerii, dyscypliny, broni palnej i białej, tudzież mody i obyczajów panujących w rozmaitych państwach Europy. Obycia nabrał w zagranicznych podróżach, zaś skutkiem przyrodzonej dyskrecji nikt nie był pewien czy pochodził w istocie z Inflant, Pomorza czy raczej z Saksonii."),
 
 ("1794_text_b", "Tyle rzec o nim mogę, z przekonaniem, co do prawdziwości mych sądów, co się zaś tyczy urodzenia był on ..."),
 ("1794_text_b_opis_1", "... potomkiem zubożałej szlachty. A twierdzę tak, albowiem jawne dowody jego szlacheckości otworzyły mu niejedne drzwi, które dla osoby mało majętnej pozostałyby zamknięte. Zarazem wiódł on żywot pełen obowiązków i odpowiedzialności, niemalże nieznośnych dla prostego człowieka."),
 ("1794_text_b_opis_2", "... potomkiem mieszczańskiego nuworysza. A twierdzę tak, albowiem dzięki majątkowi udało mu się osiągnąć wiele rzeczy, które nie były zwykle dostępne ludziom pośledniejszego pochodzenia. Przez całe życie, musiał jednak mierzyć się z obmową i rozmaitymi oszczerstwami, zazwyczaj zresztą, wygłaszanymi za jego plecami."),
 ("1794_text_b_opis_3", "... człowiekiem niewiadomego pochodzenia. A twierdzę tak, albowiem wszelkie dowody szlacheckiego urodzenia były w jego przypadku wielce mgliste i nędznie w faktach ugruntowane. Swą pozycję w życiu wywalczył jednak przebiegłością i siłą, także nikt, kto go poznał śmiałości by nie miał ciskać potwarze. To jest twierdzić zgodnie z prawdą, że korzenie jego biorą się, by tak rzec, z Liber Chamorum."), 
 
 ("1794_text_c", "Słusznie pytacie o powód jego powrotu w rodzinne strony, otóż trzeba wam wiedzieć, iż postanowił wrócić aby..."),
 ("1794_text_c_opis_1", "... był on miłośnikiem wolności, co z wielkim wyznaję upodobaniem. Światły ten młodzian dochował wierności wartościom swych przodków, opowiadając się za złotą wolnością szlachecką, a nawet postępując naprzód, pragnąc jak sądzę, oświecać też klasy niższe i stopniowo poszerzać ich prawa i przywileje. Gdy jednak słowo ciałem stać się miało, pobłażliwe uśmiechy kwitujące młodzieńcze zapały, przerodził się w karcące reprymendy ojca i spazmatyczne szlochy matki, doprowadzając naszego bohatera do rozstroju nerwów, aż wreszcie opuszczenia rodziny. Trzeba wam bowiem wiedzieć, iż  upór jego równy był niespotykanej wrażliwości."),
 ("1794_text_c_opis_2", "... odzyskać utracony przez ojca majątek. Trudno osądzić, co przyczyniło się do takiego stanu rzeczy, czy to hulaszcze życie, czy to zła koniunktura. Powiedzieć starczy, iż były to lata niepomyślne. Wielki w tym udział z pewnością miały Mocarstwa Ościenne, bezlitośnie łupiące ludność  wszelakimi cłami i podatkami. Młodzian ów, niepomny jednak na doświadczenia i rady ojca, kierując się pragnieniem zdobycia fortuny i poznania świata, wraz z jego wszystkimi rozkoszami, wierzył, że zdoła tą czy inną drogą wejść w posiadanie niezgorszego majątku."),
 ("1794_text_c_opis_3", "... odzyskać utracone przez przodków, pozycję i majątek, które na skutek zawirowań politycznych, czy to nazbyt wystawnego życia, popadły w ruinę, aby zostać wreszcie spieniężonymi za bezcen. Nie był to bynajmniej wyjątek w tamtym czasie, bowiem magnateria i szlachta, na równi skore były do pijatyki, uczty czy hucznego balu. Wielkie fortuny w niwecz obracał brak rozsądku i upadek obyczajów, widoczny zwłaszcza wśród ludzi u władzy będących i czynnie politykujących. Z pewnością przyczynili się oni również do zguby kraju. Odrzucając w niepamięć niepomyślne losy przodków, młodzian ów wyruszył do Ojczyzny, aby w niej zaistnieć i uczestniczyć w odnowie, niegdyś potężnego państwa."),
 ("1794_text_c_opis_4", "... uniknąć natrętów nękających go pozwami i wyrokami. Ze smutkiem przyznaję, iż był on utracjuszem jakich próżno szukać. Niepospolity ów człek, cechował się równie niepospolitymi potrzebami, gotów był nie dbając o dzień następny, wykazać się wielkim gestem wśród przyjaciół, a nawet obcych mu ludzi. Spławianie komorników i lichwiarzy stało się więc dla niego chlebem powszednim, jak picie i zabawa, od których nigdy nie stronił. Pewnego dnia miarka się jednak przebrała, będąc zagrożony aresztem, postanowił dyskretnie zniknąć z oczu wierzycieli."),
 
 ("1794_text_d", "Dość jednak i o tym. Warto też wspomnieć, co czynił w życiu nim skierował się ku Ojczyźnie, na progu wojny będącej. Otóż był on..."),
 ("1794_text_d_opis_1", " ... kadetem w oficerskiej szkole. Tak jak przystało człowiekowi o jego społecznej pozycji, osiągnąwszy wiek należyty, udał się do Akademii Wojskowej by uzyskać szlify. Tam doskonalił swe zdolności, jako przywódcy wojskowego i zręcznego stratega, aby pewnego dnia objąć stanowisko, które słusznie mu się należało. Wraz ze sławą, przyjść miały pieniądze i romanse, dwie rzeczy, których młody człowiek nigdy nie może mieć za mało."),
 ("1794_text_d_opis_2", " ... bojownikiem za sprawę. Skutkiem nieoczekiwanych zdarzeń jego życie skręciło na mniej utarte szlaki. Został skrzywdzony, zepchnięty na margines społeczeństwa, a mimo to nie utracił wiary w sprawiedliwość. Przepełniony został współczuciem, lecz nie pokorą i zapłonął słusznym gniewem. Wierzył, że każdy człowiek zasługuje na godne życie, a jeśli nie ma innego wyjścia to musi się o nie upomnieć siłą. Został rewolucjonistą, a cały świat miał poznać jego imię."), 
 ("1794_text_d_opis_3", " ... początkującym uczonym. Tak jak przystało młodemu człowiekowi o światłym i nieograniczonym umyśle, udał się w podróż po Europejskich Uniwersytetach, by poznać tajniki nauk i filozofii naturalnej. Tamże z uwagą słuchał wykładów i studiował księgi w nadziei, że mądrość mędrców jest zaraźliwa niczym choroby weneryczne. Jeśli zaś o te ostatnie chodzi, zachowywał dalece idącą ostrożność, zadając się jedynie z cnotliwymi mężatkami i uczęszczając do oberży, o ledwie umiarkowanie złej reputacji."), 
 ("1794_text_d_opis_4", " ... klerykiem oczekującym na święcenia. Czy to z rzeczywistego powołania, czy zwykłej chciwości, w młodości postanowił porzucić świat przemocy i trudu. Wstąpił do seminarium duchowego, by przygotować się do chwalebnej roli kapłana. Wkrótce jego życie skupiło się na potrzebach i grzechach innych ludzi, za co dziękował Bogu i modlił się, aby nie dotknęły i jego. Na próżno. Opatrzność miała dla niego inne plany i choć przyczyna, dla której odstąpił od ślubów, okryta jest tajemnicą, to przyszłość nieraz jeszcze miała go postawić na rozstajnych drogach pomiędzy sacrum i profanum."), 
 
 
 ("1794_text_end", "Wyrusz na spotkanie przygody!"),
...
# Ryan END
 ...
 If he can make this castle fall to him today, he will settle in these lands and become the ruler of this valley."),
  ...
  ("delivered_damage", "Obrażenia zadane: {reg60}."),
  ("archery_target_hit", "Odległość: {reg61} jardów. Wynik: {reg60}"),
  
  ("use_baggage_for_inventory","Aby mieć dostęp do ekwipunku w czasie bitwy skorzystaj ze skrzyni, znajdująca się na pozycji startowej."),
##  ("cant_leave_now","Can't leave the area now."),
  ("cant_use_inventory_now","Nie można teraz uzyskać dostępu do ekwipunku."),
  ("cant_use_inventory_arena","Nie można uzyskać dostępu do ekwipunku na arenie."),
  ("cant_use_inventory_disguised","Nie można uzyskać dostępu do ekwipunku w przebraniu."),
  ("cant_use_inventory_tutorial","Can't access inventory in the training camp."),
  ("1_denar", "1 talar"),
  ("reg1_denars", "{reg1} talarów"),
  ("january_reg1_reg2", "Styczeń {reg1}, {reg2}"),
  ("february_reg1_reg2", "Luty {reg1}, {reg2}"),
  ("march_reg1_reg2", "Marzec {reg1}, {reg2}"),
  ("april_reg1_reg2", "Kwiecień {reg1}, {reg2}"),
  ("may_reg1_reg2", "Maj {reg1}, {reg2}"),
  ("june_reg1_reg2", "Czerwiec {reg1}, {reg2}"),
  ("july_reg1_reg2", "Lipiec {reg1}, {reg2}"),
  ("august_reg1_reg2", "Sierpień {reg1}, {reg2}"),
  ("september_reg1_reg2", "Wrzesień {reg1}, {reg2}"),
  ("october_reg1_reg2", "Październik {reg1}, {reg2}"),
  ("november_reg1_reg2", "Listopad {reg1}, {reg2}"),
  ("december_reg1_reg2", "Grudzień {reg1}, {reg2}"),
...
##  ("you_sneaked_into_town","You have sneaked into the town of "),
  ...
  ("town_nighttime","Jest późna noc i uczciwi ludzie opuścili już ulice."),
  ("door_locked","Drzwi są zamknięte."),
  ("castle_is_abondened","Wygląda na to, że zamek nie jest zajęty."),
  ("town_is_abondened","Miasto nie ma garnizonu, który by je chronił."),
  ("place_is_occupied_by_player","To miejsce kontrolują twoje własne wojska."),
  ("place_is_occupied_by_enemy", "To miejsce kontrolują wrogie wojska."),
  ("place_is_occupied_by_friendly", "To miejsce kontrolują sojusznicze wojska."),

  ("do_you_want_to_retreat", "Czy na pewno chcesz się wycofać?"),
  ("give_up_fight", "Porzucić walkę?"),
  ("do_you_wish_to_leave_tutorial", "Czy chcesz opuścić samouczek?"),
  ("do_you_wish_to_surrender", "Czy chcesz się poddać?"),
  ("can_not_retreat", "Nie można się wycofać, wróg jest blisko!"),
##  ("can_not_leave", "Can't leave. There are enemies nearby!"),

  ("s1_joined_battle_enemy", "{s1} dołącza do bitwy po stronie wroga."),
  ("s1_joined_battle_friend", "{s1} dołącza do bitwy po twojej stronie."),
...
#  ("entrance_to_town_forbidden","It seems that the town guards have been warned of your presence and you won't be able to enter the town unchallenged."),
  ("entrance_to_town_forbidden","Strażnicy miejscy wypatrują intruzów i wygląda na to, że nie dasz rady przejść przez bramę nie przyciągając uwagi."),
  ("sneaking_to_town_impossible","Strażnicy miejscy zostali zaalarmowani. Nie dasz rady przedostać się przez bramę, niezależnie od tego, jak dobrze się przebierzesz."),

  ("battle_won", "Odniosłeś zwycięstwo w bitwie!"), #You have won the battle!
  ("battle_lost", "Odniosłeś porażkę w bitwie!"), #You have lost the battle!

  ("attack_walls_success", "Po krwawej walce twoi dzielni żołnierze przejmują mury z rąk wroga."),
  ("attack_walls_failure", "Twoi żołnierze atakując mury padają falami, a ci, którzy pozostali, szybko uciekają i dezerterują."),
  ("attack_walls_continue", "Rozpoczyna się krwawa walka i obie strony walczą równie zacięcie. Pomimo wysiłków twoich wojsk, zamek pozostaje w rękach wroga."),

  ("order_attack_success", "Twoi ludzie walczą dzielnie i pokonują wroga."),
  ("order_attack_failure", "Obserwujesz bitwę z rozpaczą, kiedy wróg wycina twoich żołnierzy i z łatwością eliminuje pozostałych."),
  ("order_attack_continue", "Pomimo przedłużającej się potyczki, twoim żołnierzom nie udało się odnieść decydującego zwycięstwa."),

  ("join_order_attack_success", "Twoi ludzie walczą wraz z sojusznikami, dzieląc się chwałą i rozbijając wroga."),
  ("join_order_attack_failure", "Obserwujesz bitwę z rozpaczą, kiedy wróg wycina twoich żołnierzy i z łatwością eliminuje pozostałych."),
  ("join_order_attack_continue", "Pomimo przedłużającej się potyczki, ani twoi żołnierze, ani sojusznicy nie odnoszą decydującego zwycięstwa nad przeciwnikiem."),

  ("siege_defender_order_attack_success", "Żołnierze z garnizonu bronią murów z najwyższą odwagą, rozbijając natarcie wroga i zręcznie zamieniając jego porażkę, a w konsekwencji w pełen odwrót."),
  ("siege_defender_order_attack_failure", "Atak szybko przeobraża się w rozlew krwi. Bohaterskie wysiłki na nic się nie zdają. Słabszy liczebnie garnizon nie może utrzymać murów i wróg sprawia, że każdy ostatni obrońca musi chwycić za miecz."),
  ("siege_defender_order_attack_continue", "Powtórne, krwawe ataki na mury nie kończą się zdobyciem ani kawałka ziemi, ale pozostaje zbyt wielu wrogów, aby obrońcy mogli ogłosić prawdziwe zwycięstwo. Oblężenie trwa."),


  ("hero_taken_prisoner", "{s1} z frakcji {s3} został wzięty do niewoli przez {s2}."), #{s1} of {s3} has been taken prisoner by {s2}.
  ("hero_freed", "{s1} z frakcji {s3} został uwolniony z niewoli przez {s2}."), #{s1} of {s3} has been freed from captivity by {s2}.
  ("center_captured", "Frakcja {s2} przejęła {s1} od frakcji {s3}."), #{s2} have taken {s1} from {s3}

  ("troop_relation_increased", "Twoje relacje z {s1} zwiększyły się z {reg1} do {reg2}."), #Your relation with {s1} has increased from {reg1} to {reg2}.
  ("troop_relation_detoriated", "Twoje relacje z {s1} zmniejszyły się z {reg1} do {reg2}."),
  ("faction_relation_increased", "Twoje relacje z {s1} zwiększyły się z {reg1} to {reg2}."),
  ("faction_relation_detoriated", "Twoje relacje z {s1} zmniejszyły się z {reg1} to {reg2}."),
  
  ("party_gained_morale", "Twój oddział zyskuje {reg1} morale."), #Your party gains
  ("party_lost_morale",   "Twój oddział traci {reg1} morale."), #Your party loses
  ("other_party_gained_morale", "{s1} zyskuje {reg1} morale."),
  ("other_party_lost_morale",   "{s1} traci{reg1} morale."),
...
##  ("your_debt_to_s1_is_changed_from_reg1_to_reg2", "Your debt to {s1} is changed from {reg1} to {reg2}."),
  ...
  ("relation_mnus_100", "Mściwy"), # -100..-94
  ("relation_mnus_90",  "Mściwy"),  # -95..-84
  ("relation_mnus_80",  "Mściwy"),
  ("relation_mnus_70",  "Nienawidzący"),
  ("relation_mnus_60",  "Nienawidzący"),
  ("relation_mnus_50",  " Wrogo nastawiony"),
  ("relation_mnus_40",  "  Rozgniewany"),
  ("relation_mnus_30",  "    Niechętny"),
  ("relation_mnus_20",  "      Narzekający"),
  ("relation_mnus_10",  "        Podejrzliwy"),
  ("relation_plus_0",   "         Obojętny"),# -5...4
  ("relation_plus_10",  "          Współpracujący"), # 5..14
  ("relation_plus_20",  "           Serdeczny"),
  ("relation_plus_30",  "            Życzliwy"),
  ("relation_plus_40",  "             Wspierający"),
  ("relation_plus_50",  "              Przyjazny"),
  ("relation_plus_60",  "               Wdzięczny"),
  ("relation_plus_70",  "                 Lubiący"),
  ("relation_plus_80",  "                  Lojalny"),
  ("relation_plus_90",  "                   Oddany"),
 ...
 and you realise that all you've done ig yourself deeper into a hole.\
...
# Surname
  ...
  ("number_of_troops_killed_reg1", "Liczba zabitych jednostek: {reg1}"),
  ("number_of_troops_wounded_reg1", "Liczba ranionych jednostek: {reg1}"),
  ("number_of_own_troops_killed_reg1", "Liczba zabitych jednostek sojuszniczych: {reg1}"),
  ("number_of_own_troops_wounded_reg1", "Liczba ranionych jednostek sojuszniczych: {reg1}"),

  ("retreat", "Odwrót!"),
  ("siege_continues", "Walka trwa..."),
  ("casualty_display", "Twoje straty: {s10}^Straty wroga: {s11}{s12}"),
  ("casualty_display_hp", "^Trafiono cię i tracisz {reg1} punktów zdrowia."),

# Quest log texts
  ("quest_log_updated", "Lista zadań została uaktualniona..."),#Quest log has been updated...
...
#multiplayer game type names
  ...
  ("party_morale_is_low", "Morale niektórych żołnierzy jest niskie!"),
  ("weekly_report", "Raport tygodniowy"),
  ("has_deserted_the_party", "opuszcza oddział."),
  ("have_deserted_the_party", "opuszczają oddział."),
  ...
  ("enemies_", "Wróg "),
  # ("routed", "Routed"),
  ("weekly_budget", "Budżet tygodniowy"),
  ...
  ("reg4_killed_reg5_wounded_reg6_routed", "{reg4} zabito, {reg5} raniono, {reg6} rozgromiono"),
  ("reg4_killed_reg5_routed", "{reg4} zabito, {reg5} rozgromiono"),
  ("reg4_killed_reg5_wounded", "{reg4} zabito, {reg5} raniono"),
  ("reg4_wounded_reg5_routed", "{reg4} raniono, {reg5} rozgromiono"),
  ("routed", "Rozgromiono"),
...
#STRINGS ADDED AFTER THE FREEZE
  ...
  ("cannot_leave_now", "Nie możesz wyjść w tym momencie."),
...
("the_coast", "the coast"),
  ...
  ("hn_1_data","24 marca 1794 rok:"),
  ("hn_1_naglowek","Historical Notes"),
  ("hn_1_tekst1","Początek Insurekcji Kościuszkowskiej."),
  ("hn_1_tekst2","krótki opis zdarzenia"),
  
  ("hn_2_data","4 kwietnia 1794 rok:"),
  ("hn_2_naglowek","Historical Notes"),
  ("hn_2_tekst1","tekst1"),
  ("hn_2_tekst2","tekst2"),
  
  ("hn_3_data","17-18 kwietnia 1794 rok:"),
  ("hn_3_naglowek","Historical Notes"),
  ("hn_3_tekst1","tekst1"),
  ("hn_3_tekst2","tekst2"),
  
  ("tukaj_mowi1","Hmm... miej się na baczności,^ są solidnie uzbrojeni."),
  ("gList_dialog1","Niema co, czekajmy aż się ściemni,^ wtedy zwodujemy szkutę..."),
  ...
  ("imiona_5","Maurycy"),
  ("imiona_6","Grzybosław"),
  ("imiona_koniec","koniec"),
  
  ("nazwiska_1","Kowalski"),
  ("nazwiska_koniec","koniec"),
  
  ("pochodzenia_1","Wielunia"),
  ("pochodzenia_koniec","Wielunia"),
  
  
  
	("trader_1_1","Eh, dla kogo jak kuję pałasze,^ a ojciec mówił, żeby narzędzia chłopom  robić.^ Ot co."),
	("trader_1_2","Kupujcie szlachetni panowie,^ przednia stal i trwałość tylko u mnie!"),
	("trader_1_3","Przychodźcie i oglądajcie,^ najprzedniejsze szable w całym województwie!"),
	("trader_1_4","Wybierajcie i kupujcie,^ najprzedniejsze rapiery w całej Rzeczpospolitej!"),
	("trader_1_5","Grosza nieszczędźcie,^ tylko u mnie, solidne rapiery i szable!"),
	("trader_1_6","Oglądajcie i wybierajcie,^ solidne pałasze i szable!"),

	("trader_2_1","Kupujcie najwyborniejsze guldynki i^ pistolety tylko u mnie!"),
	("trader_2_2","Przychodźcie drodzy panowie,^ grosza na broń nie szczędźcie!"),
	("trader_2_3","Flinty, dwururki i kurki!^ To wszystko u mnie dostaniecie."),
	("trader_2_4","Najcelniejsze pistolety, do każdej ręki!^ Wybierajcie i kupujcie!"),
	("trader_2_5","Najprzedniejsze pistolety, dla każdej ręki!^ Kupujcie tylko u mnie!"),
	
	("trader_3_1","Pierwszorzędne płótna, delie, kontusze, mam wszystko co trzeba!"),
	("trader_3_2","Najlepsze tkaniny w całym województwie, a nawet kraju!"),
	("trader_3_3","Sukna, płótna, skóry, przychodźcie, oglądajcie, wybierajcie!"),

	("trader_4_1","Najlepsze ogiery!^Najpiękniejsze klacze!^Tylko u mnie!"),
	("trader_4_2","Trzeba waszmości konia?^ Śmiało, jest w czym wybierać."),
	("trader_4_3","Może waszmość konia potrzebuje?"),
	
	("trader_5_1","placeholder"),
	("trader_6_1","placeholder"),
	("trader_7_1","placeholder"),

  
			("trader_end","a"),
  ##############################################################################################################
  ("test_rumor1","Jestem zwykłą, niewypowiedzianą plotką. Mam nadzieję, że masz się dobrze."),
  ("test_rumor2","Jestem wypowiedzianą plotką, zagłuszoną turkotem kół."),
  ("test_rumor3","Jestem plotką o Powstaniu Węgierskim przeciw Monarchii Habsburgów. Liczę, że wyświetliłam się dobrze i nie sprawię swą obecnością tutaj żadnych problemów."),
  ("test_rumor4","To znowu ja, plotka o powstaniu węgierskim. Mam nadzieję, że dobrze się wyświetliłam."),
  ("test_rumor5","Zgadnij o czym jestem plotką?^ Dobra, masz jeszcze jedną szansą, spróbuj, co ci szkodzi... naprawdę nie wiesz?^ Daj spokój. No dobra, dobra, jeśli naprawdę, naprawdę nie wiesz, to ci powiem, że jestem plotką o Powstaniu Węgierskim. Zadowolony?"),
  ("test_rumor6","Jestem nie wymądrzającą się plotką o powstaniu węgierskim."), 
  ("test_rumor7","Jestem prostą plotką w Powstaniu w Rosji."),
  ("test_rumor8","Jestem plotką o Powstaniu w Rosji, której autor zmęczył się przy pisaniu poprzednich."),
  ("test_rumor9","Jestem plotką o Powstaniu w Rosji. I mam nadzieję, że jestem we właściwym czasie na właściwym miejscu :-)"),
  ("test_rumor10","Jestem plotką młodszą od tamtych z punktu widzenia chronologii zdarzeń. Insurekcja Kościuszkowska."),
  ("test_rumor11","Jestem plotką......o............o.............o...............o! Nie powiem ci! Nie zasługujesz! Męcz się, sprawdź czy wyświetliłam się we właściwym miejcu i czasie! Dobrze, już dobrze o Insurekcji Kościuszkowskiej."),
  ("test_rumor12","Jestem zmęczoną plotką o Insurekcji Kościuszkowskiej."),
  ("test_rumor13","Jestem zmęczoną i znużoną plotką o Powstaniu Kościuszkowskim."),
  ("test_rumor14","Na tych ziemiach trwa Insurekcja Kościuszkowska, a ja jestem plotka."),
  
  ("etap3_koniec", "{s68} {playername}, jak wiesz nasza sytuacja uległa zmianie. W najbliższych dniach możemy spodziewać się wybuchu wojny. Oczekuję cię z nowymi rozkazami. Przybywaj niezwłocznie.^					Naczelnik Tadeusz Kościuszko"),
  
  ("execution_cel","Celuj!"),
  ("execution_pal","Pal!"),
  ("wyrok_rosja","panującej,^ Carycy Katarzyny II, Imperatorowej Wszechrosji"),
  ("wyrok_prusy","panującego Fryderyka Wilhelma II,^ króla Prus i elektora Branderburgii"),
  ("wyrok_austria","panującego,^ Cesarza Franciszka II Habsburga"),
  
  ("execution_citizen_1","Tacy młodzi, jakże to tak?!^ Czyż leży to w granicach sprawiedliwości Monarchii?!"),
  ("execution_citizen_2","Zasłużyli sobie, łotry!"),
  ("execution_citizen_3","Biedni chłopcy... patrzcie synowie i uczcie się!^ Aby nie zejść na drogą niesprawiedliwości, rozpusty i demokracji."),
  ("execution_citizen_4","Dziś oni ich, jutro tamci tych...^ i tak w kółko od wieków."),
  
  ("execution_prisoner_1","Zdrowaś Maryjo, łaski pełna, pan z Tobą..."),
  ("execution_prisoner_2","Bądźcie przeklęci!^ Łajdaki!"),
  ("execution_prisoner_3","Za wolność naszą i waszą!^ Śmierć poniesiemy..."),
  
  ("wyrok_1_1","W imieniu miłościwie nam {s20}."),
  ("wyrok_1_2","Skazuje się tych oto, wrogów {s20},^ na karę śmierci przez rozstrzelanie."),
  ("wyrok_1_3","Wyrok jest prawomocny i^ zostać ma wykonany niezwłocznie."),
  ("wyrok_1_4","Niech będzie w nim nauka, iż każdy^ kto przeciw koronie głowę podnosi, straci ją!"),
  
  ("endgame_f4", "{stopień} {playername}, spieszę ci donieść, iż odnieśliśmy klęskę. Utraciliśmy wszystkie ziemie, tym samym zaprzepaszczając szansę na odzyskanie niepodległości. ^^ Generał Tadeusz Kościuszko"),
  ("endgame_f3", "-{stopień} {playername}, spieszę ci donieść, iż traktaty pokojowe zostały podpisane. Nie stało się to w dogodnym dla nas momencie i utracone ziemie pozostaną poza naszą kontrolą, a Rzeczpospolita istnieć będzie jako państwo znacznie okrojone. Niepodległość w tej sytuacji zawsze będzie zagrożona.^^ Generał Tadeusz Kościuszko"),
  ("endgame_f2", "{stopień} {playername}, spieszę ci donieść, iż traktaty pokojowe zostały podpisane. Nie stało się to w dogodnym dla nas momencie i utracone ziemie pozostaną poza naszą kontrolą, a Rzeczpospolita istnieć będzie jako państwo znacznie okrojone. Niepodległość w tej sytuacji zawsze będzie zagrożona.^^ Generał Tadeusz Kościuszko"), 
  ("endgame_f1", "{stopień} {playername}, spieszę ci donieść, iż traktaty pokojowe zostały podpisane. Nie stało się to w dogodnym dla nas momencie i utracone ziemie pozostaną poza naszą kontrolą, a Rzeczpospolita istnieć będzie jako państwo znacznie okrojone. Niepodległość w tej sytuacji zawsze będzie zagrożona.^^ Generał Tadeusz Kościuszko"),
  ("endgame_0", "{stopień} {playername}, spieszę ci donieść, iż traktaty pokojowe zostały podpisane. Ziemie odebrane Targowicy pozostaną pod naszą kontrolą, niestety nie zdołaliśmy odzyskać reszty ziem, bezprawnie nam zagarniętych. Niemniej jednak, winszuję ci ostatnich zwycięstw i ufam, że z ludźmi takimi jak ty na straży granic, zdołamy utrzymać niepodległość.^^ Generał Tadeusz Kościuszko"), 
  ("endgame_1", "{stopień} {playername}, spieszę ci donieść, iż traktaty pokojowe zostały podpisane. Pod naporem naszych sił, wróg przystać musiał na nasze warunki, odzyskane ziemie pozostają pod panowaniem Rzeczpospolitej. Niepodległość będzie solą w oku monarchów, nic to jednak, gdy na straży granic mamy oficerów takich jak ty. Raz jeszcze winszuję przewag i dokonań.^^ Generał Tadeusz Kościuszko"),
  ("endgame_2", "{stopień} {playername}, spieszę ci donieść, iż traktaty pokojowe zostały podpisane. Pod naporem naszych sił, wróg przystać musiał na nasze warunki, odzyskane ziemie pozostają pod panowaniem Rzeczpospolitej. Niepodległość będzie solą w oku monarchów, nic to jednak, gdy na straży granic mamy oficerów takich jak ty. Raz jeszcze winszuję przewag i dokonań.^^ Generał Tadeusz Kościuszko"),
  ("endgame_3", "{stopień} {playername}, spieszę ci donieść, iż traktaty pokojowe zostały podpisane. Pod naporem naszych sił, wróg przystać musiał na nasze warunki, odzyskane ziemie pozostają pod panowaniem Rzeczpospolitej. Niepodległość będzie solą w oku monarchów, nic to jednak, gdy na straży granic mamy oficerów takich jak ty. Raz jeszcze winszuję przewag i dokonań.^^ Generał Tadeusz Kościuszko"),
  ("endgame_4", "{stopień} {playername}, spieszę ci donieść, iż traktaty pokojowe zostały podpisane. Pod naporem naszych sił, wróg przystać musiał na nasze warunki, odzyskane ziemie pozostają pod panowaniem Rzeczpospolitej. Niepodległość będzie solą w oku monarchów, nic to jednak, gdy na straży granic mamy oficerów takich jak ty. Raz jeszcze winszuję przewag i dokonań.^^ Generał Tadeusz Kościuszko"),
  ("endgame_5", "{stopień} {playername}, spieszę ci donieść, iż traktaty pokojowe zostały podpisane. Pod naporem naszych sił, wróg przystać musiał na nasze warunki, odzyskane ziemie pozostają pod panowaniem Rzeczpospolitej. Niepodległość będzie solą w oku monarchów, nic to jednak, gdy na straży granic mamy oficerów takich jak ty. Raz jeszcze winszuję przewag i dokonań.^^ Generał Tadeusz Kościuszko"),
  ("endgame_last", "jest wiecej regionow niz teksty wyzej"),
  
  # ("wyrok_2_1","W imię sprawiedliwości i naszej niepodległości."),
  # ("wyrok_2_2","Tych oto, zdrajców i sprzedawczyków skazuje się na jedyną słuszną karę!"),
  # ("wyrok_2_3","To jest, natychmiastowe rozstrzelanie."),
  # ("wyrok_2_4","Czeka to wszystkich, co stanęli przeciw wolności i niepodległości Rzeczpospolitej."),
  ("Regiment","Odbierz regiment i umundurowanie w obozie wojsk nieopodal Krakowa."),
  ("NadszedlCzas","Przekaż dowódcy twierdzy Radom wieść o wybuchu powstania."),
   ("4Ofensywalist", "{s68} {playername}, w związku z zaistniałą sytuacją frontową, konieczne jest przeprowadzenie kontr ofensywy. Uderz na napotkany wrogi oddział i znieś go aby nie stanowił dla nas dalszego zagrożenia. ^           Naczelnik Tadeusz Kościuszko"),
   ("4Przejmijlist", "{s68} {playername}, aby prowadzić dalsze działania wojenne, koniecznym jest przejęcie twierdzy {s1}, będącego obecnie w rękach wroga. Jest to fortyfikacja o znaczeniu dla nas strategicznym, jej odbicie może okazać się przełomowe dla losu dalszych walk.^           Naczelnik Tadeusz Kościuszko"),
  ("rewolucja_upada","Szanowny {s69}{playername}, w związku z naszym tragicznym położeniem, zawarłem rozejm z {s1}, na jego mocy nasze ziemie przechodzą pod ich panowanie, natomiast dowództwo ma prawo do opuszczenia kraju co i tobie niezwłocznie uczynić radzę."),
  ("Oboz_weg","Spotkaj się z przywódcą węgierskich konspiratorów. Z ostatnich doniesień wynika, iż przebywa w Budapeszcie."),
  ("Oboz_ros","Odszukaj obóz powstańców. Pogłoski mówią jakoby był położony nieopodal wąwozu na północny-wschód od Lwowa."),
  ("gList", "Odszukaj ludzi podejrzanych o szpiegostwo na rzecz Konfederacji Targowickiej. Powinni znajdować się nieopodal kamienicy."),
  ("Wojna", "Skontaktuj się z Naczelnikiem Tadeuszem Kościuszką, aby odebrać dalsze rozkazy."),
  ("gZdrada", "Pochwyć  targowiczan, którym udało się zbiec z Warszawy tuż przed rewolucją. Nim wyjadą poza granice kraju."),
  ("Przesluchanie", "Zaatakuj i zniszcz oddział wroga dowodzony przez oficera {s21}, weź jeńca a następnie dostarcz do Tadeusza Kościuszki."),
  ("Gaszek", "Gaszek", "Do uzupełnienia."),
  ("Zdrada", "Zdrada", "Do uzupełnienia."),
  ("List", "Do uzupełnienia."),
  ("Zniewaga", "Odnajdź rywala Ignaca Martinovicsa w Budapeszcie."),
  ("Donos", "Do uzupełnienia."),
  ("Egzekucja1", "W Debreczynie wkrótce zostaną straceni skazańcy. Dotrzyj czym prędzej do miasta i odnajdź miejsce egzekucji na przedmieściach. Musisz uwolnić jednego z nich, należącego do konspiracji."),
  ("Egzekucja2", "W Debreczynie wkrótce zostaną straceni konspiratorzy. Musisz dotrzeć czym prędzej do miasta i odbić ich."),
  ("DostarczBron2", "Konspiratorzy w mieście {s20} potrzebują broni, aby kontynuować dalsze przygotowania powstania. Skontaktuj się w mieście z jednym z konspiratorów i przekaż mu uzbrojenie."),
  ("Prusy", "Udaj się na przedmieścia i podburzaj miejscową ludność, aby wywołać zamieszki i zmniejszyć potencjał obronny miasta."),
  ("DostarczBron", "W nowo powstających oddziałach na terenie Węgier brakuje uzbrojenia. Dostarcz broń rewolucjonistom aby umożliwić większej liczbie oddziałów wzięcie udziału w powstaniu.^Wskazówka: Oddziały zostały oznaczone na mapie."),
  ("Dezercja", "Wymierz sprawiedliwość trzem oddziałom dezerterów. Na wykonanie rozkazu masz 5 dni."),
  ("Przyczolek", "Wspomóż kozaków w zdobywaniu zamku."),
  ("Manifesty", "Wygłoś manifesty w dwóch wskazanych karczmach, aby rozpowszechnić idee rewolucyjne.^Wskazówka: Karczmy zostały oznaczone na mapie."),
  ("Uniwersal", "Udaj się do karczm, aby wygłosić uniwersał Kościuszki, poszerzający prawa i przywileje chłopów.^Wskazówka: Karczmy zostały oznaczone na mapie."),
  ("kidnapped_girl", "Udaj się w kierunku Warszawy, na spotkanie Panu Iksińskiemu i jego kompanii."),
  ("Przygotowania", "Nim wyruszysz na Węgry, najmij kompanię w sile najmniej 20 ludzi. Chętnych do dołączenia do twej kompanii za godziwy grosz, znajdziesz w karczmach."),
  ("Przewrot", "Zlikwiduj oficera pretendującego do przejęcia władzy w obozie."),
  ("RamieSprawiedliwosci", "Wymierz sprawiedliwość oszczercy. Powinien znajdować się w pobliżu!"),
  ("Obelga", "Gracz ma za zadanie uciszyć człowieka szargającego reputację jednego z mieszczan."),
  ("Dlugi", "Zadaniem gracza jest odebranie długu  od trzech losowych postaci w imieniu zleceniodawcy."),
  ("Syn","Przekonaj syna jednego z mieszczan do porzucenia planu, wyruszenia na wojnę."),
  ("Uciekinier","Odnajdź Chorążego Świstackiego, który lekce sobie ważąc regulamin opuścił szeregi swego oddziału i udał się w bliżej nieznanym kierunku, aby rozprawiać wśród ludzi o swych wojennych przewagach. Miej baczenie zwłaszcza na karczmy w Koronie, karczmarze to zazwyczaj dobrze poinformowani ludzie."),
 
 ("Patrole", "W okolicy pobliskiej wioski zostały zauważone ruchy wrogich wojsk. Twoim celem jest zaatakowanie i zniesienie oddziału patrolującego tamte okolice."),
 ("Spisek", "W obozie rewolucjonistów został zawiązany spisek przeciwko przywódcy. Zduś bunt w zarodku nim rozprzestrzeni się i doprowadzi do jawnego wystąpienia przeciwko obecnemu przywódcy.^Wskazówka: Zadanie do wykonania w obrębie lokacji."),
 ("AtakNaTabory", "Atak na szlaki zaopatrzeniowe.","Zaatakuj dwa tabory przeciwnika, w celu osłabienia jego sił. "),
 ("RozpoznanieOgniem", "Ocal emisariusza działającego w {s20}. Zamieszkuje na przedmieściach, zachowaj dyskrecję i odnajdź go po zapadnięciu zmroku."),
 ("1000Zdrajca", "Zlikwiduj dowódcę garnizonu, aby zmniejszyć możliwości obronne miasta. Znajdziesz go w centrum miasta."),
 ("ZlotoMaruderow", "Znajdź i zniszcz obóz dezerterów, a następnie zrób wszystko aby  odebrać im zrabowane złoto."),
 ("Kontruderzenie", "Zaatakuj i zniszcz oddział wroga dowodzony przez oficera wrogiej frakcji i weź jeńca."),
 ("Insurekcja", "Czekaj na rozpoczęcie rewolucji na terenie Rzeczpospolitej i wspomóż Kościuszkowców w walce przeciwko Konfederacji Targowickiej.^Udaj się do naczelnika powstania - Tadeusza Kościuszki."),
 ("Szpieg", "Pochwyć i wykończ szpiega, który podejmie próbę przekazania wrogowi cennych informacji, mogących zaważyć o klęsce rewolucji. Aby go dopaść, zaczaj się w pobliżu obozu i poczekaj aż się ujawni."),
 ("Szpieg", "Pochwyć i wykończ szpiega, który podejmie próbę przekazania wrogowi cennych informacji, mogących zaważyć o klęsce rewolucji. Aby go dopaść, zaczaj się w pobliżu obozu i poczekaj aż się ujawni."),
 ("Szpieg", "Pochwyć i wykończ szpiega, który podejmie próbę przekazania wrogowi cennych informacji, mogących zaważyć o klęsce rewolucji. Aby go dopaść, zaczaj się w pobliżu obozu i poczekaj aż się ujawni."),
 ("Szpieg", "Pochwyć i wykończ szpiega, który podejmie próbę przekazania wrogowi cennych informacji, mogących zaważyć o klęsce rewolucji. Aby go dopaść, zaczaj się w pobliżu obozu i poczekaj aż się ujawni."),

 ("Zasadzka", "W górach została przygotowana zasadzka na konwój z bronią. Dotrzyj na miejsce i wzmocnij siły powstańców."),

 # ("Zamek1", ""),
 ("Emisariusz", "Pojmij lub zlikwiduj wskazanego emisariusza w karczmie {s20}. Następnie dostarcz do więzienia w Warszawie."),
 ("qemisariusz_1", "Za głowę zdrajcy czy wichrzyciela 50 rubli w złocie!^ Ponadto rychło na własność otrzymacie ziemię!"),
 ("Infiltracja", "Dowiedz się gdzie położona jest kryjówka bandytów a następnie rozbij bandę. Spróbuj zasięgnąć języka w karczmie {s20}."),
  ("Szpieg", "Pochwyć i wykończ szpiega, który podejmie próbę przekazania wrogowi cennych informacji, mogących zaważyć o klęsce rewolucji. Aby go dopaść, zaczaj się w pobliżu obozu i poczekaj aż się ujawni."),

 ("Kurland", "Doniesienie listu do jednej z karczm na Kurlandii. Skutkuje spawnem jednego oficera i jego atakiem na jeden losowy zamek z trzeciej puli. Celem gracza jest dostarczenie informacji, pomoc w zdobyciu zamku. Następnie powrót do Rzeczpospolitej. Zadanie jest nawiązaniem do powstania Kurlandzkiego."),
 ("Zamek2", "Poprowadź oddział i przejmij ważny dla sukcesu rewolucji zamek {s0}."),
 ("Zamek3", "Zbierz oficerów i przejmij miasto {s0}, kluczowy ośrodek rewolucji."),
 
  ("looters_name1_begin","Jaśko"),
  ("looters_name1_2","Zbyszko"),
  ("looters_name1_3","Walenty"),
  ("looters_name1_4","Jan"),
  ("looters_name1_5","Onufry"),
  ("looters_name1_55","Grzegorz"),
  ("looters_name1_end","error"),
  
  ("looters_name2_begin","Zbych"),
  ("looters_name2_2","Jan"),
  ("looters_name2_3","Bohdan"),
  ("looters_name2_4","Walenty"),
  ("looters_name2_5","Onufry"),
  ("looters_name2_55","Maurycy"),
  ("looters_name2_535","Feliks"),
  ("looters_name2_end","error"),
  
  ("looters_surname1_begin","Bronowic"),
  ("looters_surname1_begin2","Psićborza"),
  ("looters_surname1_begin3","Opatowa"),
  ("looters_surname1_begin4","Mścisłowa"),
  ("looters_surname1_begin5","Kań"),
  ("looters_surname1_begin6","Masłowa"),
  ("looters_surname1_begin7","Limanowej"),
  ("looters_surname1_end","error"),
  
  ("looters_surname2_begin","Dwasłowa"),
  ("looters_surname2_begin2","Trzcinka"),
  ("looters_surname2_begin3","Kufel"),
  ("looters_surname2_begin4","Kasza"),
  ("looters_surname2_end","error"),
  
  ("zbojnicy_name1_begin","Jaśko"),
  ("zbojnicy_name1_2","Zbyszko"),
  ("zbojnicy_name1_3","Walenty"),
  ("zbojnicy_name1_4","Jan"),
  ("zbojnicy_name1_5","Onufry"),
  ("zbojnicy_name1_55","Grzegorz"),
  ("zbojnicy_name1_end","error"),
  
  ("zbojnicy_name2_begin","Zbych"),
  ("zbojnicy_name2_2","Jan"),
  ("zbojnicy_name2_3","Bohdan"),
  ("zbojnicy_name2_4","Walenty"),
  ("zbojnicy_name2_5","Onufry"),
  ("zbojnicy_name2_55","Maurycy"),
  ("zbojnicy_name2_535","Ferenc"),
  ("zbojnicy_name2_end","error"),
  
  ("zbojnicy_surname1_begin","Bronowic"),
  ("zbojnicy_surname1_begin2","Psićborza"),
  ("zbojnicy_surname1_begin3","Opatowa"),
  ("zbojnicy_surname1_begin4","Mścisłowa"),
  ("zbojnicy_surname1_begin5","Kań"),
  ("zbojnicy_surname1_begin6","Masłowa"),
  ("zbojnicy_surname1_begin7","Limanowej"),
  ("zbojnicy_surname1_end","error"),
  
  ("zbojnicy_surname2_begin","Dwasłowa"),
  ("zbojnicy_surname2_begin2","Trzcinka"),
  ("zbojnicy_surname2_begin3","Kufel"),
  ("zbojnicy_surname2_begin4","Kania"),
  ("zbojnicy_surname2_end","error"),
  
  ("przemytnicy_name1_begin","Chryzostom"),
  ("przemytnicy_name1_begin2","Bożydar"),
  ("przemytnicy_name1_begin3","Walenty"),
  ("przemytnicy_name1_end","error"),
  
  ("przemytnicy_surname1_begin","Piętka"),
  ("przemytnicy_surname1_begin2","Trzygrosze"),
  ("przemytnicy_surname1_begin3","Złoty Kur"),
  ("przemytnicy_surname1_begin4","Grzybek"),
  ("przemytnicy_surname1_end","error"),
  
  ("looters_name_format1","{s0} z {s1}"),
  ("looters_name_format2","{s0} {s1}"),
  
  ("name_end","error"),
  
  ("rewolucja_wegry_lose","Mimo starannych przygotowań, powstanie na Węgrzech nie doszło do skutku..."),
  ("rewolucja_wegry_win" ,"Wybuchło powstanie na Węgrzech!"),
  
  ("5_porucznik_opis","W skład plutonu wchodzi 30 żołnierzy. Jednostka przeznaczona do walki w formacjach.^ Skuteczna szczególnie przy salwach, w ostrzale nieregularnym sprawdza się gorzej.^ Doświadczeni fizylierzy radzą sobie dobrze w walce wręcz."),
  ("5_kapitan_a_opis","W skład kompanii wchodzi 60 żołnierzy. Jednostka przeznaczona do walki w formacjach.^ Skuteczna szczególnie przy salwach, w ostrzale nieregularnym sprawdza się gorzej.^ Doświadczeni fizylierzy radzą sobie dobrze w walce wręcz."),
  ("5_kapitan_b_opis","W skład plutonu wchodzi 30 żołnierzy. Lekka piechota charakteryzuje się dużą skutecznością w walce dystansowej, z powodzeniem korzysta z tyraliery czy podwójnej linii.^ Gorzej radzi sobie w walce wręcz."),
  ("5_rotmistrz_opis","W skład szwadronu wchodzi 50 kawalerzystów. Lekka kawaleria, doskonała do przeprowadzania szybkich ataków i w celach zwiadowczych. "),
  ("5_major_a_opis","W skład batalionu wchodzi 120 żołnierzy. Jednostka przeznaczona do walki w formacjach.^ Skuteczna szczególnie przy salwach, w ostrzale nieregularnym sprawdza się gorzej.^ Doświadczeni fizylierzy radzą sobie dobrze w walce wręcz."),
  ("5_major_b_opis","W skład kompanii wchodzi 60 żołnierzy. Lekka piechota charakteryzuje się dużą skutecznością w walce dystansowej, z powodzeniem korzysta z tyraliery czy podwójnej linii. Gorzej radzi sobie w walce wręcz."),
  ("5_major_c_opis","W skład plutonu wchodzi 30 żołnierzy."),
  ("5_major_d_opis","W skład pułku wchodzi 100 kawalerzystów. Lekka kawaleria, doskonała do przeprowadzania szybkich ataków i w celach zwiadowczych."),
  ("5_major_e_opis","W skład szwadronu wchodzi 50 kawalerzystów. Kawaleria sprawdzająca się zarówno przeciwko jeździe jak i piechocie."),
  ("5_pulkownik_a_opis","W skład regimentu wchodzi 300 żołnierzy. Jednostka przeznaczona do walki w formacjach.^ Skuteczna szczególnie przy salwach, w ostrzale nieregularnym sprawdza się gorzej.^ Doświadczeni fizylierzy radzą sobie dobrze w walce wręcz."),  
  ("5_pulkownik_b_opis","W skład batalionu wchodzi 120 żołnierzy. Lekka piechota charakteryzuje się dużą skutecznością w walce dystansowej, z powodzeniem korzysta z tyraliery czy podwójnej linii. Gorzej radzi sobie w walce wręcz."),  
  ("5_pulkownik_c_opis","W skład kompanii wchodzi 60 żołnierzy. "),  
  ("5_pulkownik_d_opis","W skład brygady wchodzi 200 kawalerzystów. Lekka kawaleria, doskonała do przeprowadzania szybkich ataków i w celach zwiadowczych."),  
  ("5_pulkownik_e_opis","W skład pułku wchodzi 100 kawalerzystów. Kawaleria sprawdzająca się zarówno przeciwko jeździe jak i piechocie."),  
  ("5_general_a_opis","W skład batalionu wchodzi 120 żołnierzy. "),
  ("5_general_b_opis","W skład regimentu wchodzi 300 żołnierzy. Lekka piechota charakteryzuje się dużą skutecznością w walce dystansowej, z powodzeniem korzysta z tyraliery czy podwójnej linii. Gorzej radzi sobie w walce wręcz. "),
  ("5_general_c_opis","W skład batalionu wchodzi 120 żołnierzy. "),
  ("5_brygadier_opis","W skład brygady wchodzi 200 kawalerzystów."),
  
  ("karczmarz_text_1","Witam wielmożnego pana^ w naszych skromnych progach. "),
  ("karczmarz_text_2","Dobry,^ miło mi gościć pana. "),
  ("karczmarz_text_3","Kłaniam się i liczę,^ że dłużej zabawicie u mnie w gościnie."),
  ("karczmarz_text_end","Kłaniam się i liczę,^ że dłużej zabawicie u mnie w gościnie."),
  
  ("awans_text","Szanowny {s68} {playername}, z przyjemnością zawiadamiam, że ^ostatnimi zasługami, udowodniliście, że zasługujecie na awans. ^Aby odebrać pod swą komendę nowy regiment, ^zgłoś się bezzwłocznie do werbownika.^                            J.J. Niemcewicz"),
  ("awans_text2","Zgłoś się do werbownika, aby odebrać nowy regiment."),
  ("arms_1","Abgarowicz"),
  ("arms_2","Aksak"),
  ("arms_3","Dąb"),
  ("arms_4","Dalibór"),
  ...
  ("in_effigie_begin", "tekst_1"),
  ("in_effigie_1", "tekst_2"),
  ("in_effigie_end", "koniec"),
  
  ("land_1","Sieradzkiej"),
  ("land_2","Krakowskiej"),
  ("land_3","Wołyńskiej"),
  ("land_4","Wieluńskiej"),
  #nowe ziemie dodawac przed land_end
  ("land_end","error"),
  
  # ("reason_1","reason1"),
  #nowe przyczyny opuszczenia wlsoci dodawac przed reason_end
  ("reason_end","error"),
  
  # ("surname_1","name1"),
  #nowe nazwiska dodawac przed name_end
  ("surname_end","error"),
  
  ("anton_fiodor", "Anton, Fiodor!^ Brać go!"),
  
# Teksty bandytów w kryjówce, w zadaniu Za garść złota.
  ("infiltracja_1","Coś mi mówi, że z takiej wizyty^ to tylko kłopoty być mogą..."),
  ("infiltracja_2","Coście za jeden, hę?"),
  ("infiltracja_3","Coś mi mówi, że z takiej wizyty^ to tylko kłopoty być mogą..."),
  ("infiltracja_4","Coście za jeden, hę?"),
  ("infiltracja_5","Ruszaj, herszt czekał nie będzie."),
  ("infiltracja_6","Ruszaj, herszt czekał nie będzie."),
  
("szlachta_mieszczka_1_0","Witajcie dobrodziejko,^ znacie może gdzie kwaterę nająć? "),
("szlachta_mieszczka_1_1","Jest kilka, zależy jakiej wam potrzeba.^ Popytajcie w rynku, tam dobre znaleźć można. "),
("szlachta_mieszczka_1_2","Nie trzeba mi w rynku,^ szukam na przedmieściach. "),
("szlachta_mieszczka_1_3","Taki pan a na przedmieściach szuka?^ W szynku popytajcie, tam wszystko wiedzą. "),

("mieszczka_szlachta_1_0","Kłaniam się panu! "),
("mieszczka_szlachta_1_1","A witam, witam.^ Jak zdrowie małżonka? "),
("mieszczka_szlachta_1_2","Kuracji za miastem zażywa, u brata swego. "),
("mieszczka_szlachta_1_3","A panią na gospodarstwie samą, jedną ostawił?!^ Jakże to tak może być! "),
("mieszczka_szlachta_1_4","Może więc waszmość dotrzymasz mi towarzystwa? "),
("mieszczka_szlachta_1_5","Z wielką ochotą. ^ Trzy razy w okienko wieczorem zapukam..."),

("mieszczka_mieszczka_1_0","Witam sąsiadkę co tam słychać?^ Jak zdrowie? "),
("mieszczka_mieszczka_1_1","Eh, szkoda gadać w krzyżu łamię mnie od niedzieli... "),
("mieszczka_mieszczka_1_2","Czarciego pazura już próbowała? Nie? ^Tedy niech spróbuję, boleć przestanie jak ręką odjął. "),
("mieszczka_mieszczka_1_3","A, spróbuję, spróbuję. Cuchnie jak siedem diabłów,^ ale skoro pomóc może..."),
("mieszczka_mieszczka_1_4","Niema co wyrzekać, brać i tyle.^ Jak moja świętej pamięci babka. "),

("mieszczka_biedak_1_0","I co ze zleconą robotą?"),
("mieszczka_biedak_1_1","Na śmierć, żem zapomniał...^ skończę obecną i przyjdę naprawić ten dach."),
("mieszczka_biedak_1_2","Liczę na to,^ macie czas do jutra."),

("mieszczanin_biedak_1_0","A, witam, witam,^ kiedy to dług zamiarujecie spłacić? "),
("mieszczanin_biedak_1_1","Hę? Jaki dług? "),
("mieszczanin_biedak_1_2","Oj, nie łżyj, do wtorku czekam.^ Ni dnia dłużej. "),
("mieszczanin_biedak_1_3","Panie, ja ubogi... z czego oddam?! "),
("mieszczanin_biedak_1_4","Na wódkę wydałeś niecnoto! ^ Jak nie oddasz to na bruk pójdziesz. "),

("biedak_mieszczanin_1_0","Dobry, możny panie dajcie no na piwo... "),
("biedak_mieszczanin_1_1","Dobre sobie,^ gdzie indziej idźcie ludzi nagabywać! "),

("biedak_biedak_1_0","Bodajeś spuchł jak ul!^ Gdzie są moje pieniądze? "),
("biedak_biedak_1_1","Pewno w oberży ostawiłeś, wróć i sprawdź,^ a nie się rzucasz po próżnicy. "),
("biedak_biedak_1_2","Niech cię rozkrocznie febra trzęsie,^ parszywy złodziejaszku! "),
("biedak_biedak_1_3","Przyjdzie, przyjdzie koza do woza!^ Jeszcze odszczekasz obelgi pod stołem! "),

#Mieszczanin - mieszczanka

("mieszczanin_mieszczka_1_0","Znowuż się włóczysz po ulicach?^ Nie widzisz która godzina? "),
("mieszczanin_mieszczka_1_1","Cichaj babo,^ co drzysz się po próżnicy! "),
("mieszczanin_mieszczka_1_2","Przecie w domu miałeś być godzinę temu!^ Pewnie znowu się gdzieś łajdaczyłeś! "),
("mieszczanin_mieszczka_1_3","Dobry Boże, za jakie to grzechy mnie pokarałeś... ^ idę już, idę. "),

("mieszczanin_mieszczka_2_0","Witam sąsiadkę,^ gdzie to zmierzacie? "),
("mieszczanin_mieszczka_2_1","Przed siebie i w prawo,^ żegnam."),


# Szlachta - mieszczanin

("szlachta_mieszczanin_1_0","Witam, jestem w potrzebie..."),
("szlachta_mieszczanin_1_1","Znowu? Ileż to razy zapożyczaliście się u mnie?^ I ani grosza zwrotu, po dziś dzień nie dostałem! "),
("szlachta_mieszczanin_1_2","Zwrócę wszystek, tylko dajcie jeszcze na dziś,^ abym mógł się odegrać..."),
("szlachta_mieszczanin_1_3","Waść, to nawet własną babkę by przepuścił.^ Mowy niema. "),
("szlachta_mieszczanin_1_4","Bodajeś zdechł skąpcu parszywy!^ Jeszcze cię nauczę moresu! "),

("szlachta_mieszczanin_2_0","No i jak załatwiłeś to o co prosiłem...? "),
("szlachta_mieszczanin_2_1","Pewnie, że tak,^ w umówionym miejscu i w określonym czasie,^ to miałem powtórzyć. "),
("szlachta_mieszczanin_2_2","Świetnie się spisałeś,^ masz tu za fatygę i żebyś język za zębami trzymał."),
("szlachta_mieszczanin_2_3","Sie rozumie, możny panie... "),

("szlachta_mieszczanin_3_0","Dzień dobry, jak zdrowie małżonki,^ w domu przebywa? "),
("szlachta_mieszczanin_3_1","Witam, tak, nie narzeka.^ Miło mi, że waszmość pytasz. "),
("szlachta_mieszczanin_3_2","To dobra wiadomość, czas na mnie,^ obowiązki wzywają, żegnam. "),
# Biedak-mieszczanka

("biedak_mieszczka_1_0","Kłaniam się dobrodziejce,^ nie macie jakiejś roboty? "),
("biedak_mieszczka_1_1","Coś się może znajdzie.^ Drwa trza narąbać, skoro chętni jesteście. "),
("biedak_mieszczka_1_2","Mi robota nie straszna!^ Gdzie te drwa składuje dobrodziejka? "),
("biedak_mieszczka_1_3","Wolnego! Wytrzeźwiejcie wpierw,^ bo jak nic łapę sobie urżniecie. "),
("biedak_mieszczka_1_4","Ano, racja. Wieczorem zajdę i porąbię.^ Kłaniam się raz jeszcze..."),
# Szlachcic-Biedak

("szlachta_biedak_1_0","kwestia_1"),
("szlachta_biedak_1_1","kwestia_2"),
("szlachta_biedak_1_2","kwestia_3"),
("szlachta_biedak_1_3","kwestia_4"),
("szlachta_biedak_1_4","kwestia_5"),
("szlachta_biedak_1_5","kwestia_6"),
("szlachta_biedak_1_6","kwestia_7"),

# Biedak - szlachcic
("biedak_szlachcic_1_0","Kłaniam się uniżenie...^ wspomóżcie panie groszem na piwo... "),
("biedak_szlachcic_1_1","Dobre sobie,^ w głowach wam się już poprzewracało! "),
("biedak_szlachcic_1_2","Królu złoty! Choć pięć złoty..."),
("biedak_szlachcic_1_3","Niech was diabli! ^Naści piątaka i z drogi. "),
("biedak_szlachcic_1_4","Kłaniam się uniżenie...^ wspomóżcie panie groszem na piwo... "),
("biedak_szlachcic_1_5","Tego już za wiele,^ w głowach wam się poprzewracało! "),
("biedak_szlachcic_1_6","Królu złoty! Daj pięć złoty..."),
("biedak_szlachcic_1_7","Niech was diabli! Zejdź mi z drogi. "),


# Szlachta- Szlachta

("szlachta_szlachta_1_0","kwestia_1"),
("szlachta_szlachta_1_1","kwestia_2"),
("szlachta_szlachta_1_2","kwestia_3"),

("szlachta_szlachta_2_0","Czołem panie bracie!"),
("szlachta_szlachta_2_1","A, witam, dobrze was widzieć. ^ O czym to ostatnio mówią?"),


# Szlachta-szlachcianka

("szlachta_szlachcianka_1_0","Kłaniam się waćpanie. "),
("szlachta_szlachcianka_1_1","Miło mi waszmościa powitać. "),


# III Etap
#s30 przegrany oficer
#s31 lokacja pod ktora przegral
#s32 wygrany oficer
#s33 lokacja pod ktora wygral
#s34 pokonany wrogi oficer
#s35 lokacja pod ktora zostal pokonany

  ("III_etap_szlachta_szlachta_1_0", "Czołem, nasi znieźli oddział {s34}^ nieopodal {s35}!"),
  ("III_etap_szlachta_szlachta_1_1", "To dopiero wieść!^ Żebym to mógł ruszyć w pole...^"),
  ("III_etap_szlachta_szlachta_1_2", "Ja akces już złożyłem.^ Z wolentarzami jutro ruszamy!"),
  
  ("III_etap_szlachta_szlachta_2_0", "Podobno targowiczanie po miastach zapadli.^Zamęt wśród ludu sieją."),
  ("III_etap_szlachta_szlachta_2_1", "Dalibóg, dałbym ja takim łupnia!"),
  ("III_etap_szlachta_szlachta_2_2", "Nie unoście się, straże są na ich tropie."),
  
  ("III_etap_szlachta_szlachta_3_0", "Słyszeliście?! Podobno rosyjskie regiment tuż tuż."),
  ("III_etap_szlachta_szlachta_3_1", "Kto wam powiedział?^ Nie czyńcie rwetesu, do rzeczy."),
  ("III_etap_szlachta_szlachta_3_2", "Na rogatkach widzeli!^ Całe regimenty!"),
  ("III_etap_szlachta_szlachta_3_3", "Kto widział? Gadaj lub milcz,^ dla prowokatorów sąd i szubienica!"),

  ("III_etap_szlachta_szlachta_4_0", "Zdrajcy powieszeni jak się patrzy."),
  ("III_etap_szlachta_szlachta_4_1", "E, sznura szkoda.^ Co do za obyczaj, portrety miast sprzedawczyków wieszać."),
  ("III_etap_szlachta_szlachta_4_2", "Zaczekajcie, wkrótce i oni zawisną."),
  
  ("III_etap_szlachta_szlachta_5_0", "Zdrajcy powieszeni jak się patrzy."),
  ("III_etap_szlachta_szlachta_5_1", "E, sznura szkoda.^ Co do za obyczaj, portrety miast sprzedawczyków wieszać."),
  ("III_etap_szlachta_szlachta_5_2", "Zaczekajcie, wkrótce i oni zawisną."),
 
  ("III_etap_szlachta_szlachta_6_0", "A nie mówiłem, że dzień ten nadejdzie?^ Wojska w pole ruszyły!"),
  ("III_etap_szlachta_szlachta_6_1", "Prawda, obaczymy jeszcze czy duch w narodzie jest stały."),
  ("III_etap_szlachta_szlachta_6_2", "W naszych to rękach los powstania!"),
  
  ("III_etap_szlachta_szlachta_7_0", "Czołem, macie jakies wieści z frontu?"),
  ("III_etap_szlachta_szlachta_7_1", "Nasi znieśli oddział {s34} pod {s35}!"),
  ("III_etap_szlachta_szlachta_7_2", "Przednia wieść!^ Pokażemy gdzie raki snu zimą zaznają!"),
  
  ("III_etap_szlachta_szlachta_8_0", "Czołem, macie jakie wieści z frontu?"),
  ("III_etap_szlachta_szlachta_8_1", "Nasi w defensywie, po porażce pod {s31}."),
  ("III_etap_szlachta_szlachta_8_2", "Oby zdołali wycofać się i życie ocalić!^ Trudny czas nastał."),

# IV Etap - te później

  ("IV_etap_szlachta_szlachta_1_0", "Czołem, macie jakies wieści z frontu?"),
  ("IV_etap_szlachta_szlachta_1_1", "Nasi na {nazwa regionu odmieniona} poszli, ziemie wyzwolić^spod jarzma {nazwa wrogiej frakcji}."),
  ("IV_etap_szlachta_szlachta_1_2", "Przednia wieść!^ Pokażemy gdzie raki snu zimą zaznają!"),
  
  ("IV_etap_szlachta_szlachta_2_0", "Czołem, macie jakie wieści z frontu?"),
  ("IV_etap_szlachta_szlachta_2_1", "Nasi ziemie odzyskują w pobliżu {nazwa regionu},^ zajęte przez {nazwa wrogiej frakcji}"),
  ("IV_etap_szlachta_szlachta_2_2", "Oby zdołali!^ Trudny czas nastał."),


  
  
  
  ("3Zdrajcy", "Po przejęciu miast przez wojska powstańcze, udaj się na poszukiwanie zdrajców. Odnajdź jednego w każdym z trzech miast - Warszawie, Lublinie i Wilnie."),
  
  ("3Zdrajcy_0_0", "Czołem panie bracie."),
  ("3Zdrajcy_0_1", "Czołem."),
  ("3Zdrajcy_0_2", "Poszukują mnie straże, wspomóżcie mnie,^ a złotem zapłacę."),
  ("3Zdrajcy_0_3", "Pomoc targowiczanom to pewny szafot.^ Nie licz waść na mnie."),
  ("3Zdrajcy_0_4", "Tfu, kolejny zdrajca!^ Wszyscy wrogowie porządku prędzej czy później zawisną!"),

  ("3Zdrajcy_1_0", "Witam, waść jest woźnicą, prawda to?"),
  ("3Zdrajcy_1_1", "Ano, ojciec był woźnica, to i^ja jestem syn woźnicy i takoż woźnica."),
  ("3Zdrajcy_1_2", "Potrzeba mi szybko w drogę ruszać,^ źle się dzieje w Rzeczpospolitej."),
  ("3Zdrajcy_1_3", "Waść z Konfederatami się bratał, hę?"),
  ("3Zdrajcy_1_4", "Milcz łachudro! Masz tu złoto,^ a dziś po zmroku ruszamy."),
  ("3Zdrajcy_1_5", "Być to nie może, nie wspieram zdrajców,^ idźcie precz albo zawołam straż."),
  ("3Zdrajcy_1_6", "A, niech was diabli! ^Jeszcze na szafot pójdziecie wraz z buntownikami!"),

  ("3Zdrajcy_2_0", "poczatek"),
  ("3Zdrajcy_2_1", "kwestia 1"),
  ("3Zdrajcy_2_2", "kwestia 2"),
  ("3Zdrajcy_2_3", "koniec"),
  
  ("desc_Prusy", "Wyrusz do miasta {s20} i podburz miejscową ludność. Wykonując to zadanie zyskujesz możliwość wywołania rozruchów w pobliżu {s20}, w wybranym czasie."),
  ("desc_Emisariusz", "Pojmij emisariusza w karczmie {s20}. Następnie dostarcz do więzienia w Warszawie."),
 # ("desc_", ""),
 # ("desc_", ""),

  
  ("karczma_szlachta_b","Hym, przednie piwo^ mają w tych stronach."),
  ("karczma_szlachta_1","Niema to jak^ zacny trunek z rana..."),
  ("karczma_szlachta_2","Piwa! Byle prędzej, a grosza nie poskąpię"),
  ("karczma_szlachta_3","Zacna to austeria,^ przyznać trzeba."),
  ("karczma_szlachta_4","Eh, psie siki,^ tyle rzec można o tutejszym winie."),
  ("karczma_szlachta_5","Poszłoby się z flintą na liszka^ albo i coś większego."),
  ("karczma_szlachta_6","Co to za wódka?!^ Tfu, z psiego ogona albo i gorzej."),
  ("karczma_szlachta_e","eee"),
  
  ("karczma_kupcy_b","Hymph, oby tylko nie padało,^ bo trakty rozmiękną na amen."),
  ("karczma_kupcy_1","Zacne piwo mają^ w tej austerii."),
  ("karczma_kupcy_2","Eh, czas w drogę ruszać."),
  ("karczma_kupcy_3","Komu w drogę,^ temu czas."),
  ("karczma_kupcy_4","No, piwo piwem,^ a interes interesem...^ czas mi w drogę."),
  ("karczma_kupcy_5","Zdrowie waszmościów!"),
  ("karczma_kupcy_e","eee"),
  
  ("karczma_chlopi_b","Zacne piwo,^ zupełnie jak zeszłoroczne."),
  ("karczma_chlopi_1","Przynajmniej piwo w^ tym roku przednie."),
  ("karczma_chlopi_2","Eh, czas do chałupy wracać..."),
  ("karczma_chlopi_3","Niema co, ni grosz się^ nie ostał w sakiewce."),
  ("karczma_chlopi_4","Wszystko przepiłem...^ i co ja w chałupie powiem!?"),
  ("karczma_chlopi_5","Nic mi nie zostało,^ ani grosz..."),
  ("karczma_chlopi_e","eee"),
  
  
  ("karczma_szlachta1_b","Dobry."),
  ("karczma_szlachta1_1","Czołem."),
  ("karczma_szlachta1_2","A, witam, witam."),

  ("karczma_szlachta1_e","bbbb"),
  
  ("karczma_szlachta2_b","{playername}! ^Wiele słyszałem o waszmości."),
  ("karczma_szlachta2_1","Czy mnie oczy nie mylą? Toż to {playername}!^ Witamy, witamy."),
  ("karczma_szlachta2_2","Toż to {playername}! ^Witamy, witamy!"),
  ("karczma_szlachta2_e","bbbb"),
  
  ("karczma_szlachta3_b","Ho, ho, któż nawiedził nasze skromne progi! ^Kłaniam się waszmości!"),
  ("karczma_szlachta3_1","Zaszczyt to dla nas!^Wiele słyszałem o twych przewagach..."),
  ("karczma_szlachta3_2","Kłaniam się {playername}! ^Rad jestem widzieć sławnego oficjera..."),

  ("karczma_szlachta3_e","bbbb"),
  
  ("karczma_kupcy1_b","Dzień dobry.  "),
  ("karczma_kupcy1_1","Witam, witam. "),
  ("karczma_kupcy1_2","Czołem"),
  ("karczma_kupcy1_e","bbbb"),
  
  ("karczma_kupcy2_b","Witam pana! "),
  ("karczma_kupcy2_1","Dobry, {playername} jak mniemam? ^Słyszałem o waszmości..."),
  ("karczma_kupcy2_2","Dobry! ^Mam nadzieję, że i dla waszmości."),
  ("karczma_kupcy2_e","bbbb"),
  
  ("karczma_kupcy3_b","Witam {playername}!^ Dobrze was widzieć wśród nas."),
  ("karczma_kupcy3_1","{playername}? ^Miło mi powitać waćpana."),
  ("karczma_kupcy3_2","Dobry, {playername} jak mniemam? ^Wiele o waszmości słyszałem..."),
  ("karczma_kupcy3_e","bbbb"),
  
  ("karczma_kupcy4_b","{playername}? ^To dla nas zaszczyt."),
  ("karczma_kupcy4_1","Zaszczyt to dla nas^ powitać tak sławną personę!"),
  ("karczma_kupcy4_2","Rzadko odwiedzają nas tak znamienici oficerowie... ^witamy!"),
  ("karczma_kupcy4_e","eee"),
  
  ("karczma_chlopi1_b","Kłaniam się uniżenie!"),
  ("karczma_chlopi1_1","Witamy w skromnych progach^ wielmożnego pana!"),
  ("karczma_chlopi1_2","Kłaniam się uniżenie!"),
  ("karczma_chlopi1_e","eee"),
  
  ("sim_warchol1_b","{s20}, kto na tyle odważny,^ aby stawić mi czoła?"),
  ("sim_warchol1_1","{s20}! Stare kuśki! ^Szable tylko od {s21} nosicie, co?"),
  ("sim_warchol1_2","Tchórze i {s20}, gardzę wami...^ dalej, walczcie o swój honor!"),
  ("sim_warchol1_3","Zniewieściałe {s20},^ szabli nie umiecie dobyć?!"),
  ("sim_warchol1_e","aaa"),

  ("sim_warchol2_b","Eh, niema porządnych strzelców^ w tej mieścinie. "),
  ("sim_warchol2_1","Z kim by tu do pojedynku stanąć...^ może waćpan?"),
  ("sim_warchol2_2","Prędzej proch zamoknie, nim znajdzie się ktoś^ mający choć za grosz odwagi."),
  ("sim_warchol2_3","{s20},^ zawsze było z kim na pistolety stawać..."),
  ("sim_warchol2_4","Spróbowałbym się z kimś na pistolety..."),
  ("sim_warchol2_e","aaa"),

  
  ("weather_complain_1_1","{s20}, pogoda."),
  #{s20}Paskudna ; Parszywa; 
  ("weather_complain_1_2","Co tu począć, kusa rada,^ przyjdzie stać mi parę godzin,^ przynajmniej {s20}."),
  #{s20}piwo zacne w tej mieścinie mają, wasze zdrowie dobrzy ludzie! ; miód przedni  w okolicy mają ; napić się można w dobrej kompanii
  ("weather_complain_1_3","{s20}, znów trakty rozmiękną i^ {s21}."),
# {s20}: Do czorta; Do diabła; Zaraza
# {s21}: diabli wezmą dalszą drogę. ; nie ujadę tyle coby na popas stanąć w karczmie u Jankiela.

  ("weather_complain_2_1","Ja jeszcze nie mam kwestii."),
  ("weather_complain_3_1","{s20}, wszystkiego odechcieć się może,^ w taką pogodę, a miałem^ {s21}."),
# {s20} : Cholera ; Eh ; Święci pańscy
# {s21} : w zamtuzie zabawić nieco, nawet tego nie idzie. ;  iść ryby na targ kupić, znowu stara kijem obije.;
  ("weather_complain_3_2","Pracy tyle a tu trza,^ {s20}."),
#{s20} : siedzieć na rzyci; siedzieć i nosa z domu nie wystawiać; bezczynnie stać, jakież marnotrawstwo czasu;
  ("weather_complain_3_3","Znowu przez grząskie trakty^ {s20}."),
#{s20} : towary nie dojadą na czas ; towarów nie dostarczą i ino straty będą; handel podupadnie, a babka mówiła, że sucha wiosna idzie. 
  ("weather_complain_4_1","Znowuż, {s20},^ skaranie boskie z tą pogodą!"),
#{s20}: dzieci dom mi rozniosą; nie będę mogła pleć grządek; chłopi na targ grząskimi traktami nie zjadą.
  ("weather_complain_4_2","A starego wciąż w domu nie ma,^ {s20}."),
#{s20}:  gdzie się durny włóczy po deszczu; pewno piwsko chleje w szynku i o dziatkach, ni świecie nie pamięta; licho wie gdzie jest i z kim to się zadaję, nauczę rozumu gdy wróci.; 
  ("weather_complain_4_3","Takiego roku co,^ {s20},^ {s21}."),
#{s20}: tyle deszczu było; padało tyle; lało od świtu do nocy
#{s21}: za mojego życia nie pamiętam; nie było nigdy wcześniej;  10 lat nie było
  ("weather_complain_4_4","Jak my do wsi wrócim,^ {s20}."),
#{s20}: pewnikiem wszystkie trakty zamokną; trakty znowuż nieprzejezdne będą ; znowu stać i czekać nam przyjdzie, bez pożytku nijakiego.
  ("weather_complain_4_5","{s20},^ {s21}."),
# {s20}: W krzyżu łomie; W kościach łomie
# {s21}: eh, żyć się odechciewa; kiedyż wreszcie padać przestanie.
  ("weather_complain_4_6","Znowu {s20} nikt nie kupi,^ co my tera z tym zrobimy."),
#{s20}: zamokniętej marchewki, zamokniętego grochu, mokrych kartofli
  ("weather_complain_5_1","Znów leje, {s20},^ od trzech dni nosa nie idzie za drzwi wystawić."),
#{s20} - Psia mać ; do wszystkich diabłów ; sobaczy los
  ("weather_complain_5_2","{s20} bym kupił^ na {s21} pogodę, {s22}."),
# {s20}: Piwa; Wina; Wódki
# {s21}: taką;  parszywą; psią
# {s22}: ale kiesa pusta; lecz grosza nie ma

  ("weather_complain_end","error"),
  
  ("greeting_1_1","{s20}."),
  #{s20}: Czołem ; Moje uszanowanie ;Czołem Panie Bracie ; Witam waćpana
  ("greeting_1_2","{s20} wino w tym mieście,^ zabawię jednak {s21}."),
# {s20}: Wyborne; Przednie; Wspaniałe; Znakomite
# {s21} : dłużej w tym mieście ; jeszcze kilka dni; wszystko co dobre swój koniec ma, czas w drogę;
("greeting_1_3","{s20}, znowu gorąco,^ że nie idzie wytrzymać, {s21}."),
# {s20}: Do czorta ; Diabli nadali; Cholera
# {s21}: mogłoby popadać ; coś dawno nie padało ; 
("greeting_1_4","{s20} w tej^ {s21} mieścinie."),
# {s20}: Nie ma nic do robienia; Nic ciekawego niema ;  
# {s21}: zaplutej; parszywej;  
("greeting_1_5","Przednie {s20}, serwują w^ tutejszej karczmie,^ polecam waszmości."),
# {s20}: trunki ; miody ; wina

("greeting_1_6","Dawno szabli w garści nie miałem,^ chciałbym się z kimś sprawdzić..."),

("greeting_2_1","{s20}"),

# {s20} - Witam, {stopień wojskowy}.  ; Dzień dobry . ; Piękny dziś mamy dzień, {stopień wojskowy}. 

("greeting_2_2","Eh, nigdzie nie mogę znaleźć^ właściwej sukni,{s20}."),
# {s20}: na dzisiejszy bal ; na dzisiejszą kolację ; tylko w Paryżu piękne można kupić.

("greeting_2_3","Ależ {s20} pogoda,^ w sam raz na {s21}."),
# {s20}: piękna ; cudowna ; znakomita
# {s21}: piknik ; przejażdżkę kolasą za miasto ; spacer



("greeting_3_1","{s20}"),
# {s20} - Dobry dzień. ; Kłaniam się nisko. ; Witam. ; Dobry. ;
("greeting_3_2","{s20}, tyle słońca w jeden dzień,^ mogłoby trochę popadać."),
# {s20}: Diabli nadali; Do licha
("greeting_3_3","{s20} na^ {s21}."),
# {s20}: Doskonała pogoda; Świetna pogoda; Znakomita pogoda
# {s21}: piwo; ryby; grzyby; wizytę w szynku
("greeting_4_1","Miłego dnia."),
("greeting_4_2","Dobry"),
("greeting_4_3","Dzień dobry"),
("greeting_4_4","A, witam."),
("greeting_4_5","Urwanie głowy z tymi dzieciakami."),
("greeting_4_6","Uprać, wywiesić, sprzątnąć,^ a od czego chłop jest  w domu,^ ja się pytam."),
("greeting_4_7","Uh, {s20},^ pewno będzie burza."),
# {s20} : duszno ; straszna duchota ; parno ; 
("greeting_4_8","{s20},^ a tu tyle pracy."),
# {s20} : Piękny dzionek ; Wspaniała pogoda ; Tak gorąco

("greeting_5_1","{s20}."),

# {s20} : Dobry dzień. ; Kłaniam się nisko. ; Witam. ; Dobry. ;

("greeting_5_2","Eh, {s20} nie ma pracy^ dla człowieka z moim wykształceniem."),

# {s20} : w tym kraju ; w tym województwie ; tutaj ;

("greeting_5_3","{s20}, ale jak pada to^ przynajmniej odpocząć idzie."),

# {s20} : Cholera ; Psia mać ; Niech to licho

("greeting_5_4","Eh, za łyk zimnego piwa,^ {s20}."),

# {s20} : zrobiłbym wszystko; oddałbym życie.

  ("greeting_end","error"),
  
  ("greeting_trader_1","Eh, dla kogo jak kuję tą broń,^ a ojciec mówił, żeby narzędzia chłopom robić."),
	("greeting_trader_2","Kupujcie szlachetni panowie,^ przednia stal i trwałość tylko u mnie!"),
	("greeting_trader_3","Przychodźcie i oglądajcie,^ najlepsza broń w całym województwie!"),

	("greeting_trader_4","Najlepsza broń palna w całym kraju,^ to tylko u mnie!"),
	("greeting_trader_5","Przychodźcie drodzy panowie,^ oglądajcie, wybierajcie!"),

	("greeting_trader_6","Świeże owoce,^ warzywa i inne delicje, oglądajcie, kupujcie!"),
	("greeting_trader_7","Świeże ryby,^ wczoraj złapane, tylko u mnie!"),
	("greeting_trader_8","Najlepsze produkty,^ tylko u mnie!"),

	("greeting_trader_88","Pierwszorzędne płótna, delie, kontusze,^ mam wszystko co trzeba!"),
	("greeting_trader_9","Najlepsze tkaniny w całym województwie,^ a nawet kraju!"),
	("greeting_trader_10","Sukna, płótna, skóry, przychodźcie,^ oglądajcie, wybierajcie!"),
  ("greeting_trader_end","87"),
  
	("r1_1","Dzień dobry,^ jak zdrowie małżonki, w domu przebywa? "),
	("r1_2","Witam, tak, nie narzeka.^ Miło mi, że waszmość pytasz."),
	("r1_3","To dobra wiadomość,^ czas na mnie, pewne obowiązki czekają,^ żegnam."),

	("r2_1","Dobry, co tam słychać nowego?"),
	("r2_2","Dla kogo dobry, dla tego dobry.^Słychać, że wojna idzie z moskalem."),
	("r2_3","E, panie bracie, kto wie,^ może nasi się rozmyślą jeszcze^ i do domów wrócą."),
	("r2_4","Może, ale jak wojna będzie^ znów nasze folwarki zrujnują."),
	("r2_5","Co prawda, to prawda."),

	("r3_1","Witam szanowną sąsiada,^ jak tam interesa idą?"),
	("r3_2","Nie narzekam,^ {s20},^ mniejszy zysk niż dawniej, ale wciąż pewny."),
	# {s20} : zwodowałem wczoraj szkutę ze zbożem pod Sandomierzem; coraz więcej płótna się  sprzedaje;
	# otworzyłem nowy sklep we Lwowie; dobre plony były w roku  ubiegłym.

	("r4_1","Dobry, co u waszmościa słychać?"),
	("r4_2","{s20},^ sami widzicie, nic dobrego."),
	# {s20} : Chłopi mi uciekają z folwarku ; długi mam u tutejszego lichwiarza

	("r5_1","Co tam za granicą słychać?"),
	("r5_2","Rewolta i wojna,^ Francja bije się na kilku frontach,^ nie wiadomo co dalej z tego wyniknie."),

	("r6_1","Dzień dobry, podobno ceny ^płótna znacznie poszły w górę?"),
	("r6_2","Ano tak, przyjdzie mi ^niedługo zmienić zawód."),
	("r6_3","Nie dobrze, ^macie już coś upatrzone?"),
	("r6_4","Myślę, że najlepiej w ^handel zbożem zainwestować."),
	("r6_5","To dobry kierunek, pomyślności."),
	("r6_6","Dziękuję."),
  
  ("topic1_1","Witaj"),
  ("topic1_2","A idz w cholere..."),
  ("topic1_3","Zegnam"),
  
("greeting_guard1","Miejcie się na baczności,^ w okolicy bywa niebezpiecznie."),
("greeting_guard2","Nie hałasujcie tak,^ jeszcze wroga sprowadzicie."),
("greeting_guard3","Eh, w gardle zaschło od tego sterczenia tu,^ napiłbym się dobrego trunku."),
("greeting_guard4","Coś dziwnie cicho się zrobiło...^aż dreszcz przechodzi, brr."),
("greeting_guard5","Gdzież to ja zostawiłem manierkę..."),
("greeting_guard6","Czołem."),
("greeting_guard7","Witam."),


("string_end","error."),
("kontratak_1", "{s68} {playername}, w związku z zaistniałą sytuacją frontową, rozkazuję niezwłoczne uzupełnić siły i przystąpić do kontrataku, celem odzyskania straconych terytoriów w okolicach {s20}. ^^^^							     Naczelnik Tadeusz Kościuszko"),
("kontratak_2", "{s68} {playername}, winszuję sprawnie odpartego ataku wrogich wojsk! W związku z zaistniałą sytuacją frontową rozkazuję niezwłocznie przystąpić do kontrofensywy, naszym celem jest odzyskania terytoriów w okolicach {s20}. ^^^^							     Naczelnik Tadeusz Kościuszko"),
("atak_1", "{s68} {playername}, winszuję sprawnie przeprowadzonego kontrataku i odzyskania kluczowego dla nas terytorium! Donoszono mi, iż wkrótce nastąpi uderzenia ze strony {s20} na region {s21}. W związku z tym skieruj się czym prędzej w tamte strony, aby wesprzeć nasze siły.^^^^							     Naczelnik Tadeusz Kościuszko"),
("atak_2", "{s68} {playername}, doszły do mnie wieści, że plan przejęcia kluczowego dla nas terytorium spełzł na niczym. Jesteśmy więc zmuszeni spisać ten region na straty i bronić tego co jeszcze możemy obronić. Donoszono mi, iż wkrótce nastąpi uderzenia ze strony {s20} na region {s21}. W związku z tym skieruj się czym prędzej w tamte strony, aby wesprzeć nasze siły.^^^^							     Naczelnik Tadeusz Kościuszko"),

("kontratak_1log", "W związku z zaistniałą sytuacją frontową, rozkazuję niezwłoczne uzupełnić siły i przystąpić do kontrataku, celem odzyskania straconych terytoriów w okolicach {s20}, to jest: {s26}."),
("kontratak_2log", "W związku z zaistniałą sytuacją frontową rozkazuję niezwłocznie przystąpić do kontrofensywy, naszym celem jest odzyskania terytoriów w okolicach {s20}, to jest: {s26}."),
("atak_1log", "Wkrótce nastąpi uderzenia ze strony {s20} na region {s21} składający się z lokacji: {s26}. W związku z tym skieruj się czym prędzej w tamte strony, aby wesprzeć siły Rzeczypospolitej."),
("atak_2log", "Wkrótce nastąpi uderzenia ze strony {s20} na region {s21} składający się z lokacji: {s26}. W związku z tym skieruj się czym prędzej w tamte strony, aby wesprzeć siły Rzeczypospolitej."),


("atak_0", "{s68} {playername}. Wkrótce nastąpi uderzenia ze strony {s20} na region {s21} składający się z lokacji: {s25}. W związku z tym skieruj się czym prędzej w tamte strony, aby wesprzeć siły Rzeczypospolitej."),
]

from module_quests import quests

for quest in range(len(quests)):
	string_id = "name_"+quests[quest][0]
	strings.append((string_id, quests[quest][1]))
