      ...
      (ti_on_presentation_run,
       [
        ...
        (try_begin),
          ...
          (create_text_overlay, "$g_presentation_credits_obj_1", s1, tf_double_space|tf_vertical_align_center|tf_center_justify),
  ...
  ("multiplayer_poll", prsntf_read_only|prsntf_manual_end_only, 0, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_begin),
        (eq, 0, 0),
        (store_sub, ":string_index", 0, multiplayer_scenes_begin),
        (val_add, ":string_index", multiplayer_scene_names_begin),
        (str_store_string, s0, ":string_index"),
        (create_text_overlay, reg0, "str_poll_change_map", tf_center_justify),
      (else_try),
        (eq, 0, 1),
        (str_store_player_username, s0, 0),
      ...
      (else_try),
        ...
        (val_add, ":string_index", multiplayer_scene_names_begin),
        (str_store_string, s0, ":string_index"),
        (str_store_faction_name, s1, 0),
        (str_store_faction_name, s2, 0),
      ...
      (store_mission_timer_a, ":mission_timer"),
      (store_sub, "$g_multiplayer_poll_last_written_seconds_left", 0, ":mission_timer"),
    ...
    (ti_on_presentation_run,
     [(store_trigger_param_1, ":cur_time"),
      ...
      (try_end),
      (store_mission_timer_a, ":mission_timer"),
      (store_sub, ":time_left", 0, ":mission_timer"),
      (try_begin),
  ...
  ("battle",0,0,[
      (ti_on_presentation_load,
       [(set_fixed_point_multiplier, 1000),
		...
		###########################
		(assign, "$ChangeKey", -1),
		(assign, "$ButtonLine", -1),(assign, "$ButtonLineKey", -1),
		(assign, "$ButtonSquare", -1),(assign, "$ButtonSquareKey", -1),
		(assign, "$ButtonTyralery", -1),(assign, "$ButtonTyraleryKey", -1),
		(assign, "$ButtonFireOrder", -1),(assign, "$ButtonFireOrderKey", -1),
		(assign, "$ButtonShoot", -1),(assign, "$ButtonShootKey", -1),
		(assign, "$ButtonCrouch", -1),(assign, "$ButtonCrouchKey", -1),
		(assign, "$ButtonRefresh", -1),(assign, "$ButtonRefreshKey", -1),
		
		(create_button_overlay, "$ButtonLine", "@Podwójna linia."),(create_button_overlay, "$ButtonLineKey", "@a"),
		(create_button_overlay, "$ButtonSquare", "@Czworobok."),(create_button_overlay, "$ButtonSquareKey", "@b"),
		(create_button_overlay, "$ButtonTyralery", "@Tyraleria."),(create_button_overlay, "$ButtonTyraleryKey", "@c"),
		(create_button_overlay, "$ButtonCrouch", "@Pierwszy szereg klęka."),(create_button_overlay, "$ButtonCrouchKey", "@d"),
		(create_button_overlay, "$ButtonRefresh", "@Szlusuj."),(create_button_overlay, "$ButtonRefreshKey", "@e"),
		(create_button_overlay, "$ButtonEnd", "@Zakończ formację."),(create_button_overlay, "$ButtonEndKey", "@e"),
		
		(create_button_overlay, "$ButtonFireOrder", "@Zmiana rozkazu ostrzału"),(create_button_overlay, "$ButtonFireOrderKey", "@f"),
		(create_button_overlay, "$ButtonShoot", "@Ognia!"),(create_button_overlay, "$ButtonShootKey", "@g"),
		
		(init_position, pos0),
		(position_set_x, pos0, 40),
		(position_set_y, pos0, 400),
		(overlay_set_position, "$ButtonLine", pos0),
		(overlay_set_color, "$ButtonLine", 0xFFFFFF),
		(position_move_x, pos0, 30,1),
		(overlay_set_position, "$ButtonLineKey", pos0),
		(overlay_set_color, "$ButtonLineKey", 0xFFFFFF),
		(position_move_y, pos0, -5,1),
		(position_move_x, pos0, -30,1),

		(overlay_set_position, "$ButtonSquare", pos0),(overlay_set_color, "$ButtonSquare", 0xFFFFFF),
		(position_move_x, pos0, 30),
		(overlay_set_position, "$ButtonSquareKey", pos0),(overlay_set_color, "$ButtonSquareKey", 0xFFFFFF),
		(position_move_y, pos0, -5),
		(position_move_x, pos0, -30),

		(overlay_set_position, "$ButtonTyralery", pos0),(overlay_set_color, "$ButtonTyralery", 0xFFFFFF),
		(position_move_x, pos0, 30),
		(overlay_set_position, "$ButtonTyraleryKey", pos0),(overlay_set_color, "$ButtonTyraleryKey", 0xFFFFFF),
		(position_move_y, pos0, -5),
		(position_move_x, pos0, -30),
		
		(overlay_set_position, "$ButtonCrouch", pos0),(overlay_set_color, "$ButtonCrouch", 0xFFFFFF),
		(position_move_x, pos0, 30),
		(overlay_set_position, "$ButtonCrouchKey", pos0),(overlay_set_color, "$ButtonCrouchKey", 0xFFFFFF),
		(position_move_y, pos0, -5),
		(position_move_x, pos0, -30),
		
		(overlay_set_position, "$ButtonRefresh", pos0),(overlay_set_color, "$ButtonRefresh", 0xFFFFFF),
		(position_move_x, pos0, 30),
		(overlay_set_position, "$ButtonRefreshKey", pos0),(overlay_set_color, "$ButtonRefreshKey", 0xFFFFFF),
		(position_move_y, pos0, -5),
		(position_move_x, pos0, -30),
		
		(overlay_set_position, "$ButtonFireOrder", pos0),(overlay_set_color, "$ButtonFireOrder", 0xFFFFFF),
		(position_move_x, pos0, 30),
		(overlay_set_position, "$ButtonFireOrderKey", pos0),(overlay_set_color, "$ButtonFireOrderKey", 0xFFFFFF),
		(position_move_y, pos0, -5),
		(position_move_x, pos0, -30),

		(overlay_set_position, "$ButtonShoot", pos0),(overlay_set_color, "$ButtonShoot", 0xFFFFFF),
		(position_move_x, pos0, 30),
		(overlay_set_position, "$ButtonShootKey", pos0),(overlay_set_color, "$ButtonShootKey", 0xFFFFFF),
		(position_move_y, pos0, -5),
		(position_move_x, pos0, -30),
		
		(overlay_set_position, "$ButtonEnd", pos0),(overlay_set_color, "$ButtonEnd", 0xFFFFFF),
		(position_move_x, pos0, 30),
		(overlay_set_position, "$ButtonEndKey", pos0),(overlay_set_color, "$ButtonEndKey", 0xFFFFFF),
		(position_move_y, pos0, -5),
		(position_move_x, pos0, -30),
		
		(try_begin),
			(eq,  "$AllyType", grc_cavalry),
			(overlay_set_display, "$ButtonCrouch", 0),
			(overlay_set_display, "$ButtonCrouchKey", 0),
			(overlay_set_display, "$ButtonTyralery", 0),
			(overlay_set_display, "$ButtonTyraleryKey", 0),
			(overlay_set_display, "$ButtonSquare", 0),
			(overlay_set_display, "$ButtonSquareKey", 0),
		(try_end),
		
		(try_begin),
		]+concatenate_scripts([
                        [
                            (eq, "$KeyFormationLine", all_keys_list[x][0]),
							(str_store_string,s0,all_keys_list[x][1]),
							(overlay_set_text, "$ButtonLineKey", s0),
                            (else_try),
                            ] for x in range(0, len(all_keys_list))
                        ])+[
		(str_store_string,s0,"@INVALID KEY"),
		(try_end),(try_begin),
		]+concatenate_scripts([
                        [
                            (eq, "$KeyFormationSquare", all_keys_list[x][0]),
							(str_store_string,s0,all_keys_list[x][1]),
							(overlay_set_text, "$ButtonSquareKey", s0),
                            (else_try),
                            ] for x in range(0, len(all_keys_list))
                        ])+[
		(str_store_string,s0,"@INVALID KEY"),
		(try_end),(try_begin),
                        ...
                        [
                            (eq, "$KeyFormationTyralery", all_keys_list[x][0]),
							(str_store_string,s0,all_keys_list[x][1]),
							(overlay_set_text, "$ButtonTyraleryKey", s0),
                            (else_try),
                            ] for x in range(0, len(all_keys_list))
                        ])+[
		(str_store_string,s0,"@INVALID KEY"),
		(try_end),(try_begin),
                        ...
                        [
                            (eq, "$KeyFormationCrouch", all_keys_list[x][0]),
							(str_store_string,s0,all_keys_list[x][1]),
							(overlay_set_text, "$ButtonCrouchKey", s0),
                            (else_try),
                            ] for x in range(0, len(all_keys_list))
                        ])+[
		(str_store_string,s0,"@INVALID KEY"),
		(try_end),(try_begin),
                        ...
                        [
                            (eq, "$KeyFormationFireOrder", all_keys_list[x][0]),
							(str_store_string,s0,all_keys_list[x][1]),
							(overlay_set_text, "$ButtonFireOrderKey", s0),
                            (else_try),
                            ] for x in range(0, len(all_keys_list))
                        ])+[
		(str_store_string,s0,"@INVALID KEY"),
		(try_end),(try_begin),
                        ...
                        [
                            (eq, "$KeyFormationShoot", all_keys_list[x][0]),
							(str_store_string,s0,all_keys_list[x][1]),
							(overlay_set_text, "$ButtonShootKey", s0),
                            (else_try),
                            ] for x in range(0, len(all_keys_list))
                        ])+[
		(str_store_string,s0,"@INVALID KEY"),
		...
		(try_begin),
                        ...
                        [
                            (eq, "$KeyFormationRefresh", all_keys_list[x][0]),
							(str_store_string,s0,all_keys_list[x][1]),
							(overlay_set_text, "$ButtonRefreshKey", s0),
                            (else_try),
                            ] for x in range(0, len(all_keys_list))
                        ])+[
		(str_store_string,s0,"@INVALID KEY"),
		...
		(try_begin),
                        ...
                        [
                            (eq, "$KeyFormationEnd", all_keys_list[x][0]),
							(str_store_string,s0,all_keys_list[x][1]),
							(overlay_set_text, "$ButtonEndKey", s0),
                            (else_try),
                            ] for x in range(0, len(all_keys_list))
                        ])+[
		(str_store_string,s0,"@INVALID KEY"),
       ...
       [(store_trigger_param_1, ":object"),
		...
		(try_begin),
			...
			(assign, ":proceed", 0),
				...
				(try_begin),
					...
					(display_message, "@Podwójna linia"),
				(else_try),
					(display_message, "@Nie możesz używać tej formacji z tym oddziałem."),
				(try_end),
		(else_try),
			(eq, ":object", "$ButtonSquare"),
			(assign, ":proceed", 0),
				# (agent_get_troop_id, ":troop", "$PlayerExample"),
				(try_begin),
					# (eq,  "$Player_Type", 2),
		...
		(else_try),
			...
			(assign, ":proceed", 0),
				...
				(assign, "$Salwa",1),
		(else_try),
			(this_or_next|eq, ":object", "$ButtonLineKey"),
			(this_or_next|eq, ":object", "$ButtonSquareKey"),
			(this_or_next|eq, ":object", "$ButtonTyraleryKey"),
			(this_or_next|eq, ":object", "$ButtonCrouchKey"),
			(this_or_next|eq, ":object", "$ButtonRefreshKey"),
			(this_or_next|eq, ":object", "$ButtonFireOrderKey"),
			(this_or_next|eq, ":object", "$ButtonEndKey"),
			(eq, ":object", "$ButtonShootKey"),
			(assign, ":proceed", 0),
			
			(assign, "$ChangeKey", ":object"),
			(overlay_set_color, ":object", 0xd42121),
		(try_end),
...
##            (call_script, "script_update_order_panel", ":player_team"),
        ...
        (else_try),
          ...
          (try_begin),
            ...
            (team_set_order_position, ":player_team", grc_everyone, pos3),
			(get_player_agent_no, ":player_agent"),
			(1,"script_on_order_issued", mordr_hold, ":player_agent"),
          (try_end),
          (try_begin),
		...
		(try_begin),
			...
			(assign, ":key", -1),
					(try_begin),
                        ...
                        [
                            (key_clicked, all_keys_list[x][0]),
                            (assign, ":key", all_keys_list[x][0]),
                            (else_try),
                            ] for x in range(0, len(all_keys_list))
                        ])+[
					(try_end),
			(neq, ":key", -1),
			(try_begin),
				(eq, "$ChangeKey", "$ButtonLineKey"),
				(assign, "$KeyFormationLine", ":key"),
			(else_try),
				(eq, "$ChangeKey", "$ButtonSquareKey"),
				(assign, "$KeyFormationSquare", ":key"),
			(else_try),
				(eq, "$ChangeKey", "$ButtonTyraleryKey"),
				(assign, "$KeyFormationTyralery", ":key"),
			(else_try),
				(eq, "$ChangeKey", "$ButtonRefreshKey"),
				(assign, "$KeyFormationRefresh", ":key"),
			(else_try),
				(eq, "$ChangeKey", "$ButtonCrouchKey"),
				(assign, "$KeyFormationCrouch", ":key"),
			(else_try),
				(eq, "$ChangeKey", "$ButtonFireOrderKey"),
				(assign, "$KeyFormationFireOrder", ":key"),
			(else_try),
				(eq, "$ChangeKey", "$ButtonShootKey"),
				(assign, "$KeyFormationShoot", ":key"),
			(else_try),
				(eq, "$ChangeKey", "$ButtonEndKey"),
				(assign, "$KeyFormationEnd", ":key"),
			(try_end),
          (try_for_agents, ":cur_agent"),
  ...
  ("budget_report", 0, 0,
   [(ti_on_presentation_load,
     [(presentation_set_duration, 0),
	  ...
	  #####szpieg
	  # (try_begin),
		# (party_has_member, "p_main_party", "trp_szpieg"),
		# (val_add, ":num_lines",1),
	  # (try_end),
	  ######
...
##        (gt, ":total_wage", 0),
      ...
      (try_begin),
		...
		(troop_remove_gold, "trp_player", ":player_wealth_dif"),
		(set_show_messages, 1),
		(assign, reg0, ":player_wealth_dif"),
		(display_message, "@Płacisz żołd w wysokości: {reg0}",0xDA7C20),
  ...
  ("multiplayer_duel_start_counter", prsntf_read_only|prsntf_manual_end_only, 0, [
    ...
    (ti_on_presentation_run, [
      ...
      (store_mission_timer_a, ":current_time"),
      (store_sub, ":seconds_past_in_duel_start", ":current_time", 0),
...
("StartMenu",0,mesh_bg3,[
	(ti_on_presentation_load,
	[
		(assign, "$choose_part", 600),
		(assign, "$text_part", 601),
		
		(set_fixed_point_multiplier, 1000),
		
		(position_set_x, pos0, 500),
		(position_set_y, pos0, 500), #Pozycja Opcje
		(position_set_x, pos1, 200),
		(position_set_y, pos1, 300), #Wielkosc Opcje
		
		(call_script, "script_get_string_for_text"),#
	
		(create_text_overlay, "$text_part", s1, tf_scrollable),
		(overlay_set_text, "$text_part", s1),
        (position_set_x, pos1, 50), #50
        (position_set_y, pos1, 340),#560
        (overlay_set_position, "$text_part", pos1),
        (position_set_x, pos1, 650), #650
        (position_set_y, pos1, 350), #130
        (overlay_set_area_size, "$text_part", pos1),
		
		
		
		(position_set_x, pos0, 350),#500
		(position_set_y, pos0, 100), #Pozycja Opcje #400
		(position_set_x, pos1, 300),
		(position_set_y, pos1, 200), #Wielkosc Opcje
		
		(str_clear, s0),
		(create_text_overlay, "$choose_part", s0, tf_scrollable_style_2),
		(overlay_set_position, "$choose_part", pos0),
		(overlay_set_area_size, "$choose_part", pos1),
		(set_container_overlay, "$choose_part"),
		
		(assign, ":options", 4),
		(store_mul, "$current_y", ":options", 40),
		
		(call_script, "script_creation_get_options"),
	...
	(ti_on_presentation_event_state_change,
		[
			...
			(call_script, "script_creation_choose", ":object"),
		]),
...
("Damage", prsntf_read_only|prsntf_manual_end_only, 0, [
	(ti_on_presentation_load,
	[
		(set_fixed_point_multiplier, 1000),
		(create_mesh_overlay, "$mdamage1", "mesh_damage_a"),
		(create_mesh_overlay, "$mdamage2", "mesh_damage"),
		(position_set_x, pos1, 100000),
		(position_set_y, pos1, 100000),
		(init_position, pos0),
		(position_set_x, pos0, 1000),
		(position_set_y, pos0, 1000),
		# (overlay_set_size, "$mdamage1", pos0),
		# (overlay_set_size, "$mdamage2", pos0),
		(overlay_set_position, "$mdamage1", pos1),	
		(overlay_set_position, "$mdamage2", pos1),	
		# (overlay_animate_to_alpha, "$mdamage1", 0, 0x00),
		# (overlay_animate_to_alpha, "$mdamage2", 0, 0x00),
		(presentation_set_duration, 999999),
		]),
	(ti_on_presentation_run,
    [
		...
		(try_begin),
			(this_or_next|eq, "$DamageScreenEnabled", 0),
			(this_or_next|eq, "$BloodDisabled", 1),
			(gt, ":hp", 50),
			# (assign, "$shake", 0),
			(presentation_set_duration, 0),
		(else_try),
			(le, ":hp", 25),
			(overlay_set_position, "$mdamage2", pos0),
			(overlay_set_position, "$mdamage1", pos1),
			(eq, "$reduced_1", 0),
			# (1,"script_ReduceStats", 80),#-80%
		(else_try),
			(le, ":hp", 50),
			(overlay_set_position, "$mdamage2", pos1),
			(overlay_set_position, "$mdamage1", pos0),
			(eq, "$reduced_1", 0),
			# (1,"script_ReduceStats", 50),#-50%
...
[
	(ti_on_presentation_load,
	[
		(1,"script_init_regiments"),
		(set_fixed_point_multiplier, 1000),
		(assign, "$listSize", -1),
		(set_container_overlay, -1),
		(position_set_x, pos10, 999999),
		(position_set_y, pos10, 999999),
		...
		(1,"script_messageBoxInit"),
		
		(assign, "$currentRecruitTroop", -1),
		(assign, "$currentOverlay", -1),
		(assign, "$currentRegimentButton", -1),
		(assign, "$exit", -1),
		(assign, "$choosenPT", -1),

		##############################################################################################
		(1,"script_setup_players_titles"),
		...
		(try_begin),
			...
			(1,"script_getLeadershipReq", ":rank"),
			
			(store_sub, ":renown", "$NextPromotion", ":renown"),
			(store_sub, ":skl", ReturnValue, ":skl"),
			...
			(try_begin),
				(gt, ":renown", 0),
				(str_store_string, s2, "@{s2}^    {reg0} punktów renomy"),
			(try_end),
			(try_begin),
				(gt, ":skl", 0),
				(str_store_string, s2, "@{s2}^    {reg1} punktów przywództwa"),
			(try_end),
			
			(neg|str_is_empty, s2),

			(str_store_string, s2, "@ Do następnego awansu wymagane: {s2}"),
		(try_end),
		
		(create_text_overlay, reg0, "@Stopień: {s69}"),
		(position_set_x, pos0, 55),
		(position_set_y, pos0, 540),
		(overlay_set_position, reg0, pos0),
		(position_set_x, pos0, 1150),
		(position_set_y, pos0, 1150),
		(overlay_set_size, reg0, pos0),	
		(overlay_set_color, reg0, 0xFFFFFF),
		
		(create_text_overlay, reg0, "@{s2}"),
		(position_set_x, pos0, 10),
		(position_set_y, pos0, 480),
		(overlay_set_position, reg0, pos0),
		(position_set_x, pos0, 950),
		(position_set_y, pos0, 950),
		(overlay_set_size, reg0, pos0),	
		(overlay_set_color, reg0, 0xFFFFFF),
		
		(create_combo_label_overlay, "$rankList"),
		(init_position, pos1),
		(position_set_x, pos1, 800),
		(position_set_y, pos1, 800),
		(overlay_set_size, "$rankList", pos1),		
		(position_set_x, pos0, 999150),
		(position_set_y, pos0, 999510),
		(overlay_set_position, "$rankList", pos0),
		(troop_get_slot, ":player_rank", "trp_player", Ranga),
		# (assign, "$currentRecruitRank", ":player_rank"),
		(try_begin),
			(eq, ":player_rank", rRotmistrz),
			(overlay_add_item, "$rankList", "@Rotmistrz"),
			(overlay_add_item, "$rankList", "@Kapitan"),
		(else_try),
			(eq, ":player_rank", rKapitan),
			(overlay_add_item, "$rankList", "@Kapitan"),
			(overlay_add_item, "$rankList", "@Rotmistrz"),
		(else_try),
			(eq, ":player_rank", rGeneral),
			(overlay_add_item, "$rankList", "@Generał"),
			(overlay_add_item, "$rankList", "@Brygadier"),
		(else_try),
			(eq, ":player_rank", rBrygadier),
			(overlay_add_item, "$rankList", "@Brygadier"),
			(overlay_add_item, "$rankList", "@Generał"),
		(else_try),
			(1,"script_setup_players_titles"),
			(overlay_add_item, "$rankList", s69),
		(try_end),
		(overlay_set_val, "$rankList", 0),
		
		(1,"script_buildRegimentList", ":player_rank"),
		
		(create_text_overlay, reg0, "@Posiadany regiment:"),
		(assign, ":x", reg0),
		(position_set_x, pos1, 1200),
		(position_set_y, pos1, 1200),
		(overlay_set_size, ":x", pos1),
		(position_set_x, pos1, 20),
		(position_set_y, pos1, 130),
		(overlay_set_position, ":x", pos1),
		(overlay_set_color, ":x", 0xFFFFFF),
		
		(create_text_overlay, reg0, "@Dostępne regimenty:"),
		(assign, ":x", reg0),
		(position_set_x, pos1, 1200),
		(position_set_y, pos1, 1200),
		(overlay_set_size, ":x", pos1),
		...
		(create_image_button_overlay,"$exit","mesh_ui_c","mesh_ui_c_selected"),
		(position_set_x, pos0, 430),#pozycja
		(position_set_y, pos0, 20),
		(overlay_set_position, "$exit", pos0),
		(position_set_x, pos1, 800),#wielkość
		(position_set_y, pos1, 800),
		(overlay_set_size, "$exit", pos1),
		(overlay_set_additional_render_height, "$exit", 10),
		#
		(create_text_overlay, reg0, "@Wyjdź"),
		(position_set_x, pos0, 467),#pozycja
		(position_set_y, pos0, 26),
		(overlay_set_position, reg0, pos0),
		(position_set_x, pos0, 1260),#wielkość
		(position_set_y, pos0, 1260),
		(overlay_set_size, reg0, pos0),
		(overlay_set_additional_render_height, reg0, 10),
		...
		(str_store_string, s0, "@Nie wybrałeś żadnego regimentu."),
		(create_text_overlay, "$choosenRegimentText", s0),
		(overlay_set_color, "$choosenRegimentText", 0xFFFFFF),
		(position_set_x, pos1, 730),
		(position_set_y, pos1, 270),
		(overlay_set_position, "$choosenRegimentText", pos1),
		(position_set_x, pos1, 1000),
		(position_set_y, pos1, 1000),
		(overlay_set_size, "$choosenRegimentText", pos1),
		
		
		#(position_set_x, pos1, 730),
		#(position_set_y, pos1, 100),
		#(str_store_string, s0, "@Cena:"),
		#(create_text_overlay, "$choosenRegimentPrice", s0),
		#(overlay_set_color, "$choosenRegimentPrice", 0xFFFFFF),
		#(overlay_set_position, "$choosenRegimentPrice", pos1),
		
		(create_image_button_overlay,"$choosenRegimentBuy","mesh_ui_c","mesh_ui_c_selected"),
		(position_set_x, pos0, 760),#pozycja
		(position_set_y, pos0, 40),
		(overlay_set_position, "$choosenRegimentBuy", pos0),
		(position_set_x, pos1, 1100),#wielkość
		(position_set_y, pos1, 1000),
		(overlay_set_size, "$choosenRegimentBuy", pos1),
		(overlay_set_additional_render_height, "$choosenRegimentBuy", 9),
		
		(create_text_overlay,"$choosenRegimentBuyText","@Kup"),
		(position_set_x, pos0, 835),#pozycja
		(position_set_y, pos0, 50),
		(overlay_set_position, "$choosenRegimentBuyText", pos0),
		(position_set_x, pos0, 1300),#wielkość
		(position_set_y, pos0, 1300),
		(overlay_set_size, "$choosenRegimentBuyText", pos0),
		(overlay_set_color, "$choosenRegimentBuyText", 0x000000),
		(overlay_set_additional_render_height, "$choosenRegimentBuyText", 9),
		
		(create_image_button_overlay,"$currentRegimentRefill","mesh_ui_c","mesh_ui_c_selected"),
		(position_set_x, pos0, 760),#pozycja
		(position_set_y, pos0, 460),
		(overlay_set_position, "$currentRegimentRefill", pos0),
		(position_set_x, pos0, 1100),#wielkość
		(position_set_y, pos0, 1000),
		(overlay_set_size, "$currentRegimentRefill", pos0),
		(overlay_set_additional_render_height, "$currentRegimentRefill", 9),
		#
		(create_text_overlay, "$currentRegimentRefillText", "@Uzupełnij"),
		(position_set_x, pos0, 810),#pozycja
		(position_set_y, pos0, 470),
		(overlay_set_position, "$currentRegimentRefillText", pos0),
		(position_set_x, pos0, 1250),#wielkość
		(position_set_y, pos0, 1250),
		(overlay_set_size, "$currentRegimentRefillText", pos0),
		(overlay_set_color, "$currentRegimentRefillText", 0x000000),
		(overlay_set_additional_render_height, "$currentRegimentRefillText", 10),
		

		
		
		(create_image_button_overlay,"$currentRegimentDelete","mesh_ui_c","mesh_ui_c_selected"),
		(position_set_x, pos0, 760),#pozycja
		(position_set_y, pos0, 400),
		(overlay_set_position, "$currentRegimentDelete", pos0),
		(position_set_x, pos1, 1100),#wielkość
		(position_set_y, pos1, 1000),
		(overlay_set_size, "$currentRegimentDelete", pos1),
		(overlay_set_additional_render_height, "$currentRegimentDelete", 9),
		#
		(create_text_overlay, "$currentRegimentDeleteText", "@Usuń"),
		(position_set_x, pos0, 825),#pozycja
		(position_set_y, pos0, 410),
		(overlay_set_position, "$currentRegimentDeleteText", pos0),
		(position_set_x, pos0, 1300),#wielkość
		(position_set_y, pos0, 1300),
		(overlay_set_size, "$currentRegimentDeleteText", pos0),
		(overlay_set_color, "$currentRegimentDeleteText", 0x000000),
		(overlay_set_additional_render_height, "$currentRegimentDeleteText", 10),
		...
		(try_begin),
			(gt, ":pt", 0),
			(party_template_get_slot, ":troop", ":pt", 2),
			(assign, "$currentRecruitTroop", ":troop"),
			(assign, "$currentOverlay", "$currentRegimentButton"),
			
			(str_store_string, s0, "@ "),
			(create_text_overlay, "$currentRegimentStats", s0),
			(overlay_set_color, "$currentRegimentStats", 0xFFFFFF),
			(position_set_x, pos1, 730),
			(position_set_y, pos1, 700),
			(overlay_set_position, "$currentRegimentStats", pos1),
			(position_set_x, pos1, 1000),
			(position_set_y, pos1, 1000),
			(overlay_set_size, "$currentRegimentStats", pos1),
		(else_try),
			(str_store_string, s0, "@Nie dowodzisz regimentem."),
			(create_text_overlay, "$currentRegimentStats", s0),
			(overlay_set_color, "$currentRegimentStats", 0xFFFFFF),
			(position_set_x, pos1, 730),
			(position_set_y, pos1, 700),
		...
		(position_set_x, pos1, 12),#pozycja
		(position_set_y, pos1, 12),
		(overlay_set_position, reg0, pos1),
		(position_set_x, pos1, 14000),#wielkość
		(position_set_y, pos1, 36500),
		(overlay_set_size, reg0, pos1),
		...
		(overlay_set_color, reg0, 0x000000),
		(overlay_set_alpha, reg0, 0x88),
		(position_set_x, pos1, 720),#pozycja
		(position_set_y, pos1, 384),
		(overlay_set_position, reg0, pos1),
		(position_set_x, pos1, 13500),#wielkość
		(position_set_y, pos1, 18000),
		(overlay_set_size, reg0, pos1),
		...
		(position_set_y, pos1, 18000),
		(overlay_set_size, reg0, pos1),
		# (assign, "$choosenRegimentTab", reg0),
		(assign, "$hideRegimentTab", 1),
		
		(presentation_set_duration, 9999999999),
	...
	[
		...
		(1,"script_messageBoxEvents", ":object", ":value"),
		(eq, "$messageBoxBgID", -1),
		(try_begin),
			(eq, ":object", "$currentRegimentDelete"),
			(troop_slot_ge, "trp_player", TroopsType, 1),
			(str_store_string, s10, "@Potwierdź decyzję o zdaniu^ dowództwa nad regimentem."),
			(1,"script_messageBox", MessageBoxYesNo, "script_regimentDelete", 0, 0),
		(else_try),
			(eq, ":object", "$currentRegimentRefill"),
			(troop_slot_ge, "trp_player", TroopsType, 1),
			
			(troop_get_slot, ":pt", "trp_player", TroopsType),
			
			(party_template_get_slot, ":troop", ":pt", PTTroop),
			(party_template_get_slot, ":size", ":pt", PTSize),
			# (spawn_around_party, "p_main_party", ":pt"),
			# (assign, ":p", reg0),
			# (party_stack_get_troop_id, ":troop", ":p", 0),
			# (party_stack_get_size, ":size", ":p", 0),
			# (remove_party, ":p"),
			
			(store_troop_count_companions, ":cur", ":troop", "p_main_party"),
			(party_get_num_companions, ":cur", "p_main_party"),
			(val_sub, ":cur", 1),
			(val_sub, ":size", ":cur"),
			
			(try_begin),
				(neq, ":size", 0),
				(str_store_string, s10, "@Ilu zołnierzy potrzebujesz?"),
				(1,"script_messageBox", MessageBoxYesNo|MessageBoxSlider, "script_regimentRefill", 1, ":size"),
			(else_try),
				(display_message, "@Regiment nie poniósł żadnych strat.", 0xd42121),
			(try_end),
		(else_try),
			(eq, ":object", "$choosenRegimentBuy"),
			(neq, "$currentOverlay", -1),
			
			(assign, ":template", -1),
			(try_for_range, ":it", 0, "$listSize"),
				(troop_get_slot, ":pt", "trp_temp_array_c", ":it"),
				(party_template_get_slot, ":ov", ":pt", PTOverlay),
				(eq, "$currentOverlay", ":ov"),
				(assign, ":template", ":pt"),
			(try_end),
			
			(party_template_get_slot, reg10, ":template", PTCost),
			(try_begin),
				(troop_slot_ge, "trp_player", TroopsType, 1),
				(str_store_string, s10, "@Obecny regiment zostanie zastąpiony.^Koszt wystawienia regimentu^ wynosi {reg10}.^         Potwierdź albo zrezygnuj."),
			(else_try),
				(str_store_string, s10, "@Koszt wystawienia regimentu^ wynosi {reg10}.^         Potwierdź albo zrezygnuj."),
			(try_end),
			(1,"script_messageBox", MessageBoxYesNo, "script_regimentBuy", 0, 0),
		(else_try),
			(eq, ":object", "$exit"),
			(finish_mission),
		(else_try),
			...
			(try_begin),
				...
				(try_begin),
					(eq, ":player_rank", rRotmistrz),
					(troop_set_slot, "trp_player", Ranga, rKapitan),
				(else_try),
					(eq, ":player_rank", rKapitan),
					(troop_set_slot, "trp_player", Ranga, rRotmistrz),
				(else_try),
					(eq, ":player_rank", rGeneral),
					(troop_set_slot, "trp_player", Ranga, rBrygadier),
				(else_try),
					(eq, ":player_rank", rBrygadier),
					(troop_set_slot, "trp_player", Ranga, rGeneral),
				(try_end),
				(presentation_set_duration, 0),
				(start_presentation, "prsnt_recruitment"),
			(try_end),
		(else_try),
			(eq, ":object", "$currentRegimentButton"),
			(troop_get_slot, ":pt", "trp_player", TroopsType),
			(party_template_get_slot, ":troop", ":pt", 2),
			(assign, "$currentRecruitTroop", ":troop"),
			(assign, "$currentOverlay", ":object"),
		(else_try),
			(try_for_range, ":it", 0, "$listSize"),
				(troop_get_slot, ":pt", "trp_temp_array_c", ":it"),
				(party_template_get_slot, ":ov", ":pt", PTOverlay),
				(eq, ":object", ":ov"),
				(assign, "$currentOverlay", ":ov"),
				(party_template_get_slot, ":troop", ":pt", 2),
				(assign, "$currentRecruitTroop", ":troop"),
				(assign, "$choosenPT", ":pt"),
			(try_end),
	...
	[
		...
		(try_for_range, ":it", 0, "$listSize"),
			...
			(try_begin),
				(eq, "$currentOverlay", ":ov"),
				(overlay_set_color, ":ov", 0xAAAAAA),
				(assign, "$hideRegimentTab", 0),
			(else_try),
				(overlay_set_color, ":ov", 0xFFFFFF),
			(try_end),
		(try_end),
		(try_begin),
			(gt, "$messageBoxCallback", 0),
			(call_script, "$messageBoxCallback", -1),
		(try_end),
		(try_begin),
			(eq, "$currentOverlay", "$currentRegimentButton"),
			(overlay_set_color, "$currentRegimentButton", 0xAAAAAA),
			(assign, "$hideRegimentTab", 1),
		(else_try),
			(overlay_set_color, "$currentRegimentButton", 0xFFFFFF),
		(try_end),
		
		(try_begin),
			(neg|troop_slot_ge, "trp_player", TroopsType, 1),
			(overlay_set_color, "$currentRegimentDeleteText", 0xAAAAAA),
			(overlay_set_color, "$currentRegimentRefillText", 0xAAAAAA),
		(else_try),
			(troop_get_slot, ":pt","trp_player", TroopsType),

			(party_template_get_slot, reg1, ":pt", PTSize),
			# (spawn_around_party, "p_main_party", ":pt"),
			# (assign, ":party", reg0),
			# (party_stack_get_size, reg1, ":party", 0),
			# (party_stack_get_size, reg0, ":party", 0),
			# (store_troop_count_companions, reg0, ":troop", "p_main_party"),
			# (remove_party, ":party"),
			...
			(str_store_string, s0, "@Stan regimentu: {reg0}/{reg1}"),
			(overlay_set_text, "$currentRegimentStats", s0),
		...
		(try_begin),
			(try_begin),
				(eq, "$hideRegimentTab", 1),
				(overlay_set_text, "$choosenRegimentText", "@Nie wybrałeś żadnego regimentu."),
				...
				(overlay_set_size, "$choosenRegimentText", pos1),
			(else_try),
				(party_template_get_slot, reg1, "$choosenPT", PTSize),
				# (spawn_around_party, "p_main_party", "$choosenPT"),
				# (assign, ":party", reg0),
				# (party_stack_get_size, reg1, ":party", 0),
				# (remove_party, ":party"),
				(party_template_get_slot, reg2, "$choosenPT", PTCost),
				(store_troop_gold, reg3, "trp_player"),
			
			
				(str_store_string, s1, "@Liczebność regimentu: {reg1}^^Cena: {reg2}^^Złoto: {reg3}"),
				(overlay_set_text, "$choosenRegimentText", s1),
			...
			(store_sub, ":switch", 1,"$hideRegimentTab"),			
			# (overlay_set_display, "$choosenRegimentPrice", ":switch"),
			(overlay_set_display, "$choosenRegimentBuyText", ":switch"),
			(overlay_set_display, "$choosenRegimentBuy", ":switch"),
...
("DuelRank",0,0,[
	...
	[
		(set_fixed_point_multiplier, 1000),
		(position_set_x, pos10, 99999),
		(position_set_y, pos10, 99999),
		# (assign, "$troop_list", -1),
		(str_clear, s1),

		# (create_text_overlay, "$troop_list", s1, tf_scrollable),
		# (position_set_x, pos1, 59),
		# (position_set_y, pos1, -85),
		# (overlay_set_position, "$troop_list", pos1),
		# (position_set_x, pos1, 400),
		# (position_set_y, pos1, 720),
		# (overlay_set_area_size, "$troop_list", pos1),
		# (set_container_overlay, "$troop_list"),
		
		(assign, "$currentRankTroop", "trp_player"),
		
		(try_begin),
			(eq, "$duel_type", 1),
			(assign, ":ranking", "trp_ranking_sword"),
		(else_try),
			(assign, ":ranking", "trp_ranking_pistol"),
		(try_end),
		
		(troop_get_slot, ":ilosc", ":ranking",1000),
		
		(store_mul, ":cur_y", ":ilosc", 20),
		(val_add, ":cur_y", 180),
		(init_position, pos0),
		(init_position, pos1),
		...
		(val_add, ":ilosc", 1),
		(assign, reg2, 1),
		(try_for_range, ":i", 0, ":ilosc"),
			(troop_get_slot, ":troop", ":ranking",":i"),
			(position_set_x, pos0, 50),
			(position_set_y, pos0, ":cur_y"),
			(str_store_troop_name, s2, ":troop"),
			(str_store_string, s0, "@{reg2}. {s2}"),
			(create_button_overlay, ":overlay", s0),
			(overlay_set_position, ":overlay", pos0),
			(overlay_set_color, ":overlay", 0xEEEEEE),
			(init_position, pos1),
			(position_set_x, pos1, 1100),
			(position_set_y, pos1, 1100),
			(overlay_set_size, ":overlay", pos1),
			
			(troop_set_slot, ":troop", TroopIndex, ":overlay"),
			(val_sub, ":cur_y", 25),
			(val_add, reg2, 1),
		(try_end),
		(troop_get_slot, ":pov", "trp_player", TroopIndex),
		(overlay_set_color, ":pov", 0xAAAAAA),
		(set_container_overlay, -1),
		###############################################################################
		(create_mesh_overlay, reg0, "mesh_ui_d"),
		(init_position, pos0),
		(position_set_x, pos0, 41),#pozycja
		(position_set_y, pos0, 679),
		(overlay_set_position, reg0, pos0),
		(position_set_x, pos0, 0),
        (position_set_y, pos0, 0),
        (position_set_z, pos0, 0),
        (overlay_set_mesh_rotation, reg0, pos0),
		
		(create_mesh_overlay, reg0, "mesh_ui_g"),
		(init_position, pos0),
		(position_set_x, pos0, 41),#pozycja
		(position_set_y, pos0, 34),
		(overlay_set_position, reg0, pos0),
		(position_set_x, pos0, 0),
        (position_set_y, pos0, 0),
        (position_set_z, pos0, 0),
		...
		(create_mesh_overlay, reg0, "mesh_ui_e"),
		(init_position, pos0),
		(position_set_x, pos0, 244),#pozycja
		(position_set_y, pos0, 34),
		(overlay_set_position, reg0, pos0),
		(position_set_x, pos0, 0),
        (position_set_y, pos0, 0),
		...
		(create_mesh_overlay, reg0, "mesh_ui_f"),
		(init_position, pos0),
		(position_set_x, pos0, 244),#pozycja
		(position_set_y, pos0, 679),
		(overlay_set_position, reg0, pos0),
		...
		(overlay_set_color, reg0, 0x000000),
		(overlay_set_alpha, reg0, 0x88),
		(position_set_x, pos1, 38),#pozycja
		(position_set_y, pos1, 30),
		(overlay_set_position, reg0, pos1),
		(position_set_x, pos1, 14000),#wielkość
		(position_set_y, pos1, 35000),
		(overlay_set_size, reg0, pos1),
		
		(create_mesh_overlay, reg0, "mesh_white_plane"),
		(overlay_set_color, reg0, 0x000000),
		(overlay_set_alpha, reg0, 0x88),
		(position_set_x, pos1, 400),#pozycja
		(position_set_y, pos1, 110),
		(overlay_set_position, reg0, pos1),
		(position_set_x, pos1, 9000),#wielkość
		(position_set_y, pos1, 6700),
		(overlay_set_size, reg0, pos1),
		
		###############################################################################
		(create_text_overlay, reg0, "@Ranking Pojedynków"),
		(position_set_x, pos1, 1170), #50
		(position_set_y, pos1, 1170),#560
		(overlay_set_size, reg0, pos1),
		(position_set_x, pos1, 75), #50
		(position_set_y, pos1, 686),#560
		(overlay_set_position, reg0, pos1),
		(overlay_set_color, reg0, 0xFFFFFF),
		
		(create_text_overlay, "$text_part", s1, tf_scrollable),
		(overlay_set_text, "$text_part", s1),
		(position_set_x, pos1, 422), #50
		(position_set_y, pos1, 110),#560
		(overlay_set_position, "$text_part", pos1),
			(try_begin),
				(eq, "$duel_type", 1),
				(troop_get_slot, reg0, "$currentRankTroop", BrawlerSwordWins),
				(troop_get_slot, reg1, "$currentRankTroop", BrawlerSwordLoses),
				(troop_get_slot, reg2, "$currentRankTroop", DuelScoreSword),
			(else_try),
				(troop_get_slot, reg0, "$currentRankTroop", BrawlerPistolWins),
				(troop_get_slot, reg1, "$currentRankTroop", BrawlerPistolLoses),
				(troop_get_slot, reg2, "$currentRankTroop", DuelScorePistol),
			(try_end),

			(str_store_string, s1, "@Zwycięstwa: {reg0}^Porażki: {reg1}^Wynik: {reg2}"),
			(overlay_set_text, "$text_part", s1),
		(overlay_set_color, "$text_part", 0xFFFFFF),
	
		(create_image_button_overlay,"$exit","mesh_ui_c","mesh_ui_c_selected"),
		(position_set_x, pos0, 750),#pozycja
		(position_set_y, pos0, 30),
		(overlay_set_position, "$exit", pos0),
		(position_set_x, pos1, 900),#wielkość
		(position_set_y, pos1, 900),
		(overlay_set_size, "$exit", pos1),
		#
		(create_text_overlay, reg0, "@Wyjdź"),
		(position_set_x, pos0, 795),#pozycja
		(position_set_y, pos0, 36),
		(overlay_set_position, reg0, pos0),
		(position_set_x, pos0, 1300),#wielkość
		(position_set_y, pos0, 1300),
		(overlay_set_size, reg0, pos0),
	...
	[
		...
		(else_try),
			...
			(try_for_range, ":i", 0, ":ilosc"),
				(troop_get_slot, ":troop", ":ranking",":i"),
				(troop_slot_eq, ":troop", TroopIndex, ":object"),
				
				(try_begin),
					(neq, "$currentRankTroop", -1),
					(troop_get_slot, ":index", "$currentRankTroop",TroopIndex),
					(neq, ":index", ":object"),
					(overlay_set_color, ":index", 0xEEEEEE),
				(try_end),
				
				(assign, "$currentRankTroop", ":troop"),
				(overlay_set_color, ":object", 0xAAAAAA),
			(try_end),
			...
			(str_store_string, s1, "@Wins: {reg0}^Loses: {reg1}^Score: {reg2}"),
			(overlay_set_text, "$text_part", s1),
...
(ti_on_presentation_load,
    ...
    (create_text_overlay, "$choices", s1, tf_scrollable),
    (position_set_x, pos1, 59),
    (position_set_y, pos1, 100),
    (overlay_set_position, "$choices", pos1),
    (position_set_x, pos1, 240),
    (position_set_y, pos1, 520),
    (overlay_set_area_size, "$choices", pos1),
    (set_container_overlay, "$choices"),
	...
	(troop_get_slot, ":ilosc", ":ranking",1000),
	(store_add, ":ilosc", ":num",1),

	(assign, reg2, 1),
	(try_for_range, ":i", 0, ":ilosc"),
		(troop_get_slot, ":troop", ":ranking",":i"),
		(position_set_x, pos0, 5),
		(position_set_y, pos0, ":cur_y"),
		(str_store_troop_name, s2, ":troop"),
		(str_store_string, s0, "@{reg2}. {s2}"),
		(create_button_overlay, ":overlay", s0),
	...
	(try_for_range, ":i", 0, ":ilosc"),
		(troop_get_slot, ":troop" ,":ranking", ":i"),
		(create_mesh_overlay_with_tableau_material, ":image", -1, "tableau_troop_note_mesh", ":troop"),
		(overlay_set_position, ":image", pos10),
		(troop_set_slot, ":troop", TroopImageIndex, ":image"),
		(val_add, ":image", 1),
	(try_end),
	
	# (str_store_string, s1, "str_tutorial_3_msg_2"),
	
	(create_text_overlay, "$text_part", s1, tf_scrollable),
	(overlay_set_text, "$text_part", s1),
    (position_set_x, pos1, 350), #50
    (position_set_y, pos1, 0),#560
    (overlay_set_position, "$text_part", pos1),
    (position_set_x, pos1, 200), #650
    (position_set_y, pos1, 690), #130
	(overlay_set_area_size, "$text_part", pos1),
	
	(create_button_overlay,"$exit","@Wyjdz"),
	
	(position_set_x, pos0, 150),
	(position_set_y, pos0, 700),
	(overlay_set_position, "$exit", pos0),
...
[
	...
	(try_for_range, ":i", 0, ":ilosc"),
		(troop_get_slot, ":troop", ":ranking", ":i"),
		(troop_slot_eq,":troop", TroopIndex, ":object"),
		(try_for_range, ":i2", 0, ":ilosc"),
			(troop_get_slot, ":trp", ":ranking", ":i2"),
			(troop_get_slot, ":img", ":trp", TroopImageIndex),
			(overlay_animate_to_position, ":img",1, pos10),
			
			(troop_get_slot, ":ov", ":trp", TroopIndex),
			(overlay_set_color, ":ov", 0x000000),
		(try_end),

		(troop_get_slot, ":img", ":troop", TroopImageIndex),
		(troop_get_slot, ":ov", ":troop", TroopIndex),
		(overlay_set_color, ":ov", 0x00008B),
		(overlay_animate_to_position, ":img",1, pos2),
		
		
		
		(try_begin),
			(eq, "$duel_type", 1),
			(troop_get_slot, reg0, ":troop", BrawlerSwordWins),
			(troop_get_slot, reg1, ":troop", BrawlerSwordLoses),
			(troop_get_slot, reg2, ":troop", DuelScoreSword),
		(else_try),
			(troop_get_slot, reg0, ":troop", BrawlerPistolWins),
			(troop_get_slot, reg1, ":troop", BrawlerPistolLoses),
			(troop_get_slot, reg2, ":troop", DuelScorePistol),
		(try_end),
  ...
  ("letter", 0, mesh_list,
   [
     (ti_on_presentation_load,
      [
	  (set_fixed_point_multiplier, 1000),
	  # (str_store_string, s0, "@saidnasufnuasnf nasunfu asfnua nsufnua funun asufna fas^dfndnufnjudn fdnfn judsnfnjs nfdf dnfdhfuhdhfdhfhuppppppppppppppppppppppppp^^^gfgsgdsgdsgsdgdsgdgdsg"),
      (create_text_overlay, reg0, s100, tf_center_justify),
	  # (overlay_set_alpha, reg0, 210),
	  ...
	  (create_button_overlay, "$g_continue", "@Kontynuuj"),
      (position_set_x, pos1, 450),
      (position_set_y, pos1, 270),
      (overlay_set_position, "$g_continue", pos1),
   ...
   ("Dialog",0,0,[
     (ti_on_presentation_load,
      ...
      # (create_mesh_overlay, reg0, "mesh_white_plane"),
      # (overlay_set_color, reg0, 0x000000),
      # (overlay_set_alpha, reg0, 0x66),
      # (position_set_x, pos1, 250),
      # (position_set_y, pos1, 500),
      # (overlay_set_position, reg0, pos1),
      # (position_set_x, pos1, 38000),
      # (position_set_y, pos1, 20000),
      # (overlay_set_size, reg0, pos1),
	  
	  # (create_mesh_overlay, reg0, "mesh_dial_background"),
	  # (position_set_x, pos1, 400),
      # (position_set_y, pos1, 500),
      # (overlay_set_size, reg0, pos1),
      # (position_set_x, pos1, 1010),
      # (position_set_y, pos1, 745),
      # (overlay_set_position, reg0, pos1),

	  (create_text_overlay, "$text_part", "@Witaj {playername}", tf_scrollable|tf_vertical_align_center|tf_center_justify),
	  (overlay_set_color,"$text_part",0xffffff),
	  (position_set_x, pos1, 270),
      ...
      # (position_set_y, pos1, -350),
      # (overlay_set_position, reg0, pos1),
      # (position_set_x, pos1, 80000),
      # (position_set_y, pos1, 30000),
      # (overlay_set_size, reg0, pos1),
      ...
      (position_set_y, pos1, 400),
      (overlay_set_size, reg0, pos1),
      (position_set_x, pos1, 1020),
      (position_set_y, pos1, 235),
      (overlay_set_position, reg0, pos1),
	  
	  
	  (str_clear, s0),
      (create_text_overlay, "$dialogs_container", s0, tf_scrollable),
      (position_set_x, pos1, 0),
      (position_set_y, pos1, 0),
      (overlay_set_position, "$dialogs_container", pos1),
      (position_set_x, pos1, 980),
      (position_set_y, pos1, 190),
      (overlay_set_area_size, "$dialogs_container", pos1),
      (set_container_overlay, "$dialogs_container"),
	  
	  (assign, ":cur_y",0),

	  (create_button_overlay, reg0, "@Bywaj"),
      (position_set_x, pos1, 300),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, reg0, pos1),
	  (overlay_set_color, reg0, 0xffffff),
	  (val_add, ":cur_y",40),
	  (assign, "$exit_dialog",reg0),
	  
	  (get_player_agent_no,":player"),
	  
	  (agent_get_position,pos6,"$g_dialog_agent"),
	  (agent_get_position,pos7,":player"),
	  (position_copy_rotation, pos6,pos7),
	  (position_rotate_z,pos6,180),
	  (agent_set_position, "$g_dialog_agent",pos6),
	  (1,"script_agent_look_at_agent", "$g_dialog_agent", ":player"),

	  (agent_get_position, pos5, "$g_dialog_agent"),
	  
	  (mission_cam_set_mode,1),
	  (position_move_z, pos5, 125,0),
	  (position_rotate_z, pos5,150),
	  (position_move_y, pos5, -95,0),
	  (position_move_x, pos5, -10,0),
	  (mission_cam_animate_to_position,pos5,1000),
	  
	   (set_container_overlay, -1),
	  
	  
	  (assign, "$minimal_cost",5),
	  (assign, "$maximal_cost",100),

	  (create_slider_overlay, "$slider", "$minimal_cost", "$maximal_cost"),
      (overlay_set_val, "$slider", "$minimal_cost"),
      (position_set_x, pos1, 500),
      (position_set_y, pos1, 300),
      (overlay_set_position, "$slider", pos1),
	  (assign, reg1, "$minimal_cost"),
	  (create_text_overlay, "$cost_text", "@{reg1}"),
      (position_set_x, pos1, 700),
      (position_set_y, pos1, 300),
      (overlay_set_position, "$cost_text", pos1),
	  (overlay_set_color, "$cost_text", 0xffffff),
	...
	(ti_on_presentation_event_state_change,
      [	  
		 ...
		 (try_begin),
			(eq, ":object", "$slider"),
			(assign, reg1, ":value"),
			(overlay_set_text, "$cost_text","@{reg1"),
		(else_try),
			(eq, ":object", "$exit_dialog"),
  ...
  ("dymek", prsntf_read_only|prsntf_manual_end_only, 0, [
    (ti_on_presentation_load, 
    [
	# (eq,0,1),
      (set_fixed_point_multiplier, 1000),
      ...
      (try_for_agents, ":agent"),
		...
		(get_distance_between_positions_in_meters, ":dist", pos1, pos3),
		(le, ":dist", 15),
		(position_move_z, pos1, 210),
		(agent_get_horse, ":horse", ":agent"),
		(try_begin),
		  (ge, ":horse", 0),
		  (position_move_z, pos1, 50),
		(try_end),
		# (lt, ":limit", AgentTextLimit),
		(copy_position, pos4, pos1),
        (position_get_screen_projection, pos5, pos4),
		# (position_move_x, pos5, 15),
		(str_clear, s0),
		# (assign, ":break", 0),
		# (try_for_agents, ":a2"),
			# (eq, ":break", 0),
			# (neq, ":a2", ":agent"),
			# (neq, ":a2", ":my_agent"),
			# (agent_get_position, pos10, ":a2"),
			# (get_distance_between_positions_in_meters, ":dist", pos10, pos1),
			# (le, ":dist", 5),
			# (1,"script_get_text_for_citizen", ":a2"),
			# (neg|str_is_empty, s0),
			# (assign, ":break", 1),
		# (try_end),
		# (eq, ":break", 0),
		
		(1,"script_get_text_for_citizen", ":agent"),
		(store_sub, ":scale", 16, ":dist"),
		(val_mul, ":scale", 1000),
		(val_div, ":scale", 15),
		(try_begin),
			(agent_slot_eq, ":agent", Action, 10),
			(assign, ":scale", 800),
		(try_end),
		# (val_add, ":limit", 1),
		...
		(init_position, pos6),
		(position_set_x, pos6, ":scale"),
		(position_set_y, pos6, ":scale"),
		(overlay_set_size, reg1, pos6),
		(try_begin),
			(agent_slot_eq, ":agent", TalkQuest, 1),
			(overlay_set_color, reg1, 0x00007f),
		(else_try),
			(overlay_set_color, reg1, 0xffffff),
		(try_end),
		(agent_set_slot, ":agent",Text,reg1),
	  (try_end),
      (presentation_set_duration, 99999),
      ]),
    (ti_on_presentation_run,
  ...
  ("koniec_gry", 0, mesh_bg4, [
    (ti_on_presentation_run, 
    [
		(eq, "$Refresh",1),
		(assign, "$Refresh",0),
		(1,"script_get_text_for_page", "$CurrentPage"),
		(overlay_set_text, "$Text", s0),
	]),
    (ti_on_presentation_load, 
    [
		(presentation_set_duration, 99999999),
        (set_fixed_point_multiplier, 1000),
		...
		(assign, "$Refresh",1),
		(assign, "$PresentationGameEND",0),
		
		(create_text_overlay, "$Text", s0,0),
		(init_position, pos0),
		(position_set_x, pos0, 100),
		(position_set_y, pos0, 500),
		(overlay_set_position, "$Text", pos0),
		
		# (create_button_overlay, "$Page1", "mesh_white_plane", "mesh_white_plane"),
		# (create_button_overlay, "$Page2", "mesh_white_plane", "mesh_white_plane"),
		# (create_button_overlay, "$Page3", "mesh_white_plane", "mesh_white_plane"),
		# (create_button_overlay, "$Page4", "mesh_white_plane", "mesh_white_plane"),
		(create_button_overlay, "$Continue", "@Continue..."),
		
		# (overlay_set_text, "$Page1", "@1"),
		# (overlay_set_text, "$Page2", "@2"),
		# (overlay_set_text, "$Page3", "@3"),
		# (overlay_set_text, "$Page4", "@4"),
		...
		(overlay_set_position, "$Continue",pos0),
		# (overlay_set_position, "$Page1",pos1),
		# (overlay_set_position, "$Page2",pos2),
		# (overlay_set_position, "$Page3",pos3),
		# (overlay_set_position, "$Page4",pos4),
	]),
	...
	(ti_on_presentation_event_state_change,[
		...
		(else_try),
			(eq, ":object", "$Page4"),
			(assign, "$CurrentPage",4),
			(assign, "$Refresh",1),
		(else_try),
			(eq, ":object", "$Continue"), 
			(assign,"$PresentationGameEND",1),
			(presentation_set_duration, 0),
		(try_end),
	]),
  ...
  ("historical_note", 0, mesh_load_window, [
    (ti_on_presentation_load, 
    [
		(presentation_set_duration, 0),
        (set_fixed_point_multiplier, 1000),
		
		(create_mesh_overlay, reg10, reg4),
		(position_set_x, pos0, 1000),
		(position_set_y, pos0, 1000),
		(overlay_set_size, reg10, pos0),
		(position_set_x, pos0, 0),
		(position_set_y, pos0, 0),
		(overlay_set_position, reg10, pos0),
		
		(create_button_overlay, "$exit_dialog","@Continue",0),
		(position_set_x, pos0, 150),
		(position_set_y, pos0, 200),
		(overlay_set_position, "$exit_dialog",pos0),
		(overlay_set_text, "$exit_dialog", "@Continue"),
		
		# (str_store_string, s1, "@Historical Notes"),
		(str_store_string, s1, reg1),
		# (display_message, "@s1 = {s1} {reg1}",0xffff00),
		(create_text_overlay, reg10 ,s1,0),
		(position_set_x, pos0, 400),
		(position_set_y, pos0, 700),
		(overlay_set_position, reg10,pos0),
		(overlay_set_text, reg10, s1),
		
		# (str_store_string, s0, "@24 marca 1794 rok:"),
		(str_store_string, s0, reg0),
		# (display_message, "@s0 = {s0} {reg0}",0xffff00),
		(create_text_overlay, reg10 ,s0,0),
		(position_set_x, pos0, 100),
		(position_set_y, pos0, 500),
		(overlay_set_position, reg10,pos0),
		(overlay_set_text, reg10, s0),
		
		# (str_store_string, s2, "@Początek Insurekcji Kościuszkowskiej."),
		(str_store_string, s2, reg2),
		# (display_message, "@s2 = {s2} {reg2}",0xffff00),
		(create_text_overlay, reg10 ,s2,0),
		(position_set_x, pos0, 300),
		(position_set_y, pos0, 600),
		(overlay_set_position, reg10,pos0),
		(overlay_set_text, reg10, s2),
		
		# (str_store_string, s3, "@krótki opis zdarzenia"),
		(str_store_string, s3, reg3),
		# (display_message, "@s3 = {s3} {reg3}",0xffff00),
		(create_text_overlay, reg10 ,s3,0),
		(position_set_x, pos0, 300),
		(position_set_y, pos0, 500),
		(overlay_set_position, reg10,pos0),
		(overlay_set_text, reg10, s3),
  ...
  ("karczma", prsntf_manual_end_only, 0, [
    (ti_on_presentation_load, 
    [
		...
		#(party_get_slot, ":dna", "$current_town", slot_party_ai_rationale),
		#(assign, "$CurTableauDNA", ":dna"),
	#		(create_mesh_overlay_with_tableau_material, reg1, -1, "tableau_troop_note_mesh", "trp_karczma_karczmarz"),
	#		(position_set_x, pos1, 450),
	#		(position_set_y, pos1, 450),
	#		(overlay_set_size, reg1, pos1),
	...
	#		(position_set_y, pos1, 450),
	#		(overlay_set_position, reg1, pos1),
		(assign, "$CurTableauDNA", 0),
		
		(assign, ":cur_y", 170),
		
			(create_mesh_overlay, reg0, "mesh_ui_d"),
			(init_position, pos0),
			(position_set_x, pos0, 303),#pozycja
			(position_set_y, pos0, 315),
			(overlay_set_position, reg0, pos0),
			(position_set_x, pos0, 0),
			(position_set_y, pos0, 0),
			(position_set_z, pos0, 0),
			...
			(create_mesh_overlay, reg0, "mesh_ui_e"),
			(init_position, pos0),
			(position_set_x, pos0, 625),#pozycja
			(position_set_y, pos0, 70),
			(overlay_set_position, reg0, pos0),
			(position_set_x, pos0, 0),
			(position_set_y, pos0, 0),
			...
			(create_mesh_overlay, reg0, "mesh_white_plane"), #ramka
			(overlay_set_color, reg0, 0x000000),
			(overlay_set_alpha, reg0, 0x88),
			(position_set_x, pos1, 300),#pozycja
			(position_set_y, pos1, 65),
			(overlay_set_position, reg0, pos1),
			(position_set_x, pos1, 20000),#wielkość
			(position_set_y, pos1, 15000),
			(overlay_set_size, reg0, pos1),
		
		(try_begin),
			(eq,0,1),
			(check_quest_active, "qst_Manifesty"),
			(this_or_next|quest_slot_eq, "qst_Manifesty", QuestSlot+0, "$g_encountered_party"),
			(			  quest_slot_eq, "qst_Manifesty", QuestSlot+1, "$g_encountered_party"),
			# (create_button_overlay, "$oManifest","@Wygłoś manifest.",0),
			# (position_set_x, pos0, 200),
			# (position_set_y, pos0, ":cur_y"),
			# (val_sub, ":cur_y", 30),
			# (overlay_set_position, "$oManifest",pos0),
			# (overlay_set_text, "$oManifest", "@Wygłoś manifest."),
			
			(create_image_button_overlay,"$oManifest","mesh_ui_c","mesh_ui_c_selected"),
			(position_set_x, pos0, 380),#pozycja
			(position_set_y, pos0, 295),
			(overlay_set_position, "$oManifest", pos0),
			(position_set_x, pos1, 1300),#wielkość
			(position_set_y, pos1, 800),
			(overlay_set_size, "$oManifest", pos1),
		    (overlay_set_additional_render_height, "$oManifest", 9),
			
			(assign, ":wyzej", 5),
			
			(val_add, ":cur_y", ":wyzej"),
			(create_text_overlay, reg0, "@Wygłoś manifest."),
			(position_set_x, pos0, 420),#pozycja
			(position_set_y, pos0, 301),
			(overlay_set_position, reg0, pos0),
			(position_set_x, pos0, 1100),#wielkość
			(position_set_y, pos0, 1100),
			(overlay_set_size, reg0, pos0),
			(val_sub, ":cur_y", ":wyzej"),
			 (overlay_set_additional_render_height, reg0, 10),
			(val_sub, ":cur_y", 130),
		...
		# (create_button_overlay, reg11,"@Wejdź do środka.",0),
		# (position_set_x, pos0, 200),
		# (position_set_y, pos0, ":cur_y"),
		# (val_sub, ":cur_y", 30),
		# (overlay_set_position, reg11,pos0),
		# (overlay_set_text, reg11, "@Wejdź do środka."),
			(create_image_button_overlay,reg11,"mesh_ui_c","mesh_ui_c_selected"),
			(position_set_x, pos0, 380),#pozycja
			(position_set_y, pos0, 240),
			(overlay_set_position, reg11, pos0),
			(position_set_x, pos1, 1300),#wielkość
			(position_set_y, pos1, 800),
			(overlay_set_size, reg11, pos1),
			(overlay_set_additional_render_height, reg11, 9),
			
			(assign, ":wyzej", 5),
			
			(val_add, ":cur_y", ":wyzej"),
			
			(create_text_overlay, reg0, "@Wejdź do środka."),
			(position_set_x, pos0, 420),#pozycja
			(position_set_y, pos0, 245),
			(overlay_set_position, reg0, pos0),
			(position_set_x, pos0, 1100),#wielkość
			(position_set_y, pos0, 1100),
			(overlay_set_size, reg0, pos0),
		...
		# (create_button_overlay, "$okarczma_rest","@Zatrzymaj się na jakiś czas. (5 złociszy)",0),
		# (position_set_x, pos0, 200),
		# (position_set_y, pos0, ":cur_y"),
		# (val_sub, ":cur_y", 30),
		# (overlay_set_position, "$okarczma_rest",pos0),
		# (overlay_set_text, "$okarczma_rest", "@Zatrzymaj się na jakiś czas. (5 złociszy)"),
		
			(create_image_button_overlay,"$okarczma_rest","mesh_ui_c","mesh_ui_c_selected"),
			(position_set_x, pos0, 380),#pozycja
			(position_set_y, pos0, 185),
			(overlay_set_position, "$okarczma_rest", pos0),
			(position_set_x, pos1, 1300),#wielkość
			(position_set_y, pos1, 800),
			(overlay_set_size, "$okarczma_rest", pos1),
			(overlay_set_additional_render_height, "$okarczma_rest", 9),
			
			(assign, ":wyzej", 5),
			
			(val_add, ":cur_y", ":wyzej"),
			(1, "script_getRestCost", "p_main_party"),
			(create_text_overlay, reg0, "@Zatrzymaj się na jakiś czas."),
			(position_set_x, pos0, 384),#pozycja
			(position_set_y, pos0, 191),
			(overlay_set_position, reg0, pos0),
			(position_set_x, pos0, 1030),#wielkość
			(position_set_y, pos0, 1030),
			(overlay_set_size, reg0, pos0),
			(val_sub, ":cur_y", ":wyzej"),
			 (overlay_set_additional_render_height, reg0, 10),
			(val_sub, ":cur_y", 120),
		...
		(try_begin),
			...
			(lt, ":g", 5),
			(overlay_set_alpha, "$okarczma_rest", 0x7f),
			(assign, "$okarczma_rest",-1),
		(try_end),
		
			(create_image_button_overlay,"$exit_dialog","mesh_ui_c","mesh_ui_c_selected"),
			(position_set_x, pos0, 380),#pozycja
			(position_set_y, pos0, 130),
			(overlay_set_position, "$exit_dialog", pos0),
			(position_set_x, pos1, 1300),#wielkość
			(position_set_y, pos1, 800),
			(overlay_set_size, "$exit_dialog", pos1),
			 (overlay_set_additional_render_height, "$exit_dialog", 9),
			...
			(create_text_overlay, reg0, "@Wyjdź..."),
			(position_set_x, pos0, 465),#pozycja
			(position_set_y, pos0, 135),
			(overlay_set_position, reg0, pos0),
			(position_set_x, pos0, 1100),#wielkość
			(position_set_y, pos0, 1100),
			(overlay_set_size, reg0, pos0),
		...
		# (str_store_string, s1, "@Karczma"),
		# (create_text_overlay, reg10 ,s1,0),
		# (position_set_x, pos0, 100),
		# (position_set_y, pos0, 615),
		# (overlay_set_position, reg10,pos0),
		# (overlay_set_text, reg10, s1),
        (assign, reg30,4412),
		(try_begin),
	...
	(ti_on_presentation_event_state_change,
      [	  
		 ...
		 (try_begin),
			...
			(presentation_set_duration,0),
			(assign, "$BreakPresentation", 1),
			(change_screen_map),
		 (else_try),
			(eq, ":object", "$oManifest"),

			(assign, "$Manifest","$g_encountered_party"),
			(assign, "$Manifest","$g_encountered_party"),
			(assign, "$Manifest","$g_encountered_party"),
			(assign, "$Manifest","$g_encountered_party"),
			(assign, "$Manifest","$g_encountered_party"),
			...
			(rest_for_hours, 8, 10, 1),
			(assign, "$BreakPresentation", 1),
			(presentation_set_duration,0),
		 (else_try),
		    (eq, ":object", "$okarczma_rest"),
			(1, "script_getRestCost", "p_main_party"),
			(troop_remove_gold, "trp_player", reg1),
			(assign, "$Resting", 1),
			(set_fixed_point_multiplier, 1000),
			(party_get_position, pos1, "p_main_party"),
			(position_get_x, "$rest_x", pos1),
			(position_get_y, "$rest_y", pos1),
			
			(set_shader_param_int, "@disableUI", 0),
			(presentation_set_duration,0),
			(assign, "$BreakPresentation", 1),
			(rest_for_hours_interactive, 924, 10, 0),
		 (else_try),
		   (eq,":object",reg11),
		   (set_shader_param_int, "@disableUI", 0),
		   (store_sub, ":offset", "$current_town", "p_karczma_a"),
	...
	("quest_end",0, mesh_load_window,[
		...
		[
			...
			(position_set_x, pos1, 400),
			(position_set_y, pos1, 700),
			(create_text_overlay, reg10, "@Zwycięstwo!"),
			(overlay_set_color, reg10, 0x007f00),
			(try_begin),
				(eq, "$QuestFailed",1),
				(overlay_set_text, reg10, "@Porażka!"),
				(overlay_set_color, reg10, 0xd42121),
			(try_end),
			...
			(position_set_x, pos1, 400),
			(position_set_y, pos1, 200),
			(create_button_overlay, reg11, "@Kontynuuj..."),
			...
			(try_begin),
				(eq, "$QuestFailed",1),
				(quest_get_slot, reg1, "$EndedQuest", WinLevelFail),
				(neq, reg1,0),
				(assign, ":color", 0xd42121),
			(else_try),
				(quest_get_slot, reg1, "$EndedQuest", WinLevelSucceed),
				(assign, ":color", 0x007f00),
			(try_end),
			(create_text_overlay, reg0, "@Ilość punktów do współczynnika: {reg1}"),
			...
			(try_begin),
				...
				(assign, reg1, 0),
			(else_try),
				(quest_get_slot, reg1, "$EndedQuest", QuestGoldReward),
				(assign, ":color", 0x007f00),
			(try_end),
			(create_text_overlay, reg0, "@Wysokość nagrody pieniężnej: {reg1}"),
			(overlay_set_position, reg0, pos2),
			(overlay_set_color, reg0, ":color"),
			(val_sub, ":cur_y",40),
			(assign, ":color", 0x000000),
			...
			(try_begin),
				...
				(assign, ":color", 0x000000),
			(else_try),
				(quest_get_slot, reg1, "$EndedQuest", QuestSucceedRenownReward),
				(assign, ":color", 0x007f00),

			(try_end),
			(create_text_overlay, reg0, "@Uzyskana renoma: {reg1}"),
			(overlay_set_position, reg0, pos2),
			(overlay_set_color, reg0, ":color"),
			(val_sub, ":cur_y",40),
			# (display_message, "@DEBUGP: 1"),
			(assign, "$QuestFailed",0),
			(assign, "$QuestSucceeded",0),
			(eq, "$QuestSucceeded", "$QuestSucceeded"),
			(presentation_set_duration, 9999999999),
		]),
		(ti_on_presentation_event_state_change,[	  
			(store_trigger_param_1, ":object"),
	...
	("duel",0, 0,[
		...
		[
			...
			(init_position, pos1),
			 ...
			 (create_mesh_overlay_with_tableau_material, reg1, -1, "tableau_troop_note_mesh", "$duel_troop1"),
			 (position_set_x, pos1, 450),
			 (position_set_y, pos1, 450),
			 (overlay_set_size, reg1, pos1),
			 (position_set_x, pos1, 325), #pozycja postaci lewej
			 (position_set_y, pos1, 460),
			 (overlay_set_position, reg1, pos1),
			 (create_mesh_overlay_with_tableau_material, reg1, -1, "tableau_troop_note_mesh", "$duel_troop2"),
			 (position_set_x, pos1, 450),
			 (position_set_y, pos1, 450),
			 (overlay_set_size, reg1, pos1),
			 (position_set_x, pos1, 552),#pozycja postaci prawej
			 (position_set_y, pos1, 460),
			 (overlay_set_position, reg1, pos1),
			
			# (str_store_troop_name, s1, "$duel_troop1"),
			# (str_store_troop_name, s2, "$duel_troop2"),
			
			# (create_text_overlay, reg1, s1),
			# (position_set_x, pos1, 100), #pozycja tekstu lewego
			# (position_set_y, pos1, 600),
			# (overlay_set_position, reg1, pos1),
			
			# (create_text_overlay, reg1, s2),
			# (position_set_x, pos1, 790), #pozycja tekstu prawego
			# (position_set_y, pos1, 600),
			# (overlay_set_position, reg1, pos1),
			...
			(try_begin),
				(eq, "$duel_type", 1),
				(troop_get_slot, reg10, "$duel_troop1", BrawlerSwordRank),
			(else_try),
				(troop_get_slot, reg10, "$duel_troop1", BrawlerPistolRank),
			(try_end),
			(store_troop_gold, reg12, "$duel_troop1"),
			(str_store_string, s1, "@Pozycja: {reg10} ^Złoto: {reg12}"),
			
			(store_troop_gold, reg0, "$duel_troop1"),
			(try_begin),
				(lt, reg0, 200),
				(create_mesh_overlay, reg5,"mesh_coins_a"),
			(else_try),
				(lt, reg0, 1000),
				(create_mesh_overlay, reg5,"mesh_coins_b"),
			(else_try),
				(lt, reg0, 2000),
				(create_mesh_overlay, reg5,"mesh_coins_c"),
			(else_try),
				(lt, reg0, 3000),
				(create_mesh_overlay, reg5,"mesh_coins_d"),
			(else_try),
				(lt, reg0, 4500),
				(create_mesh_overlay, reg5,"mesh_coins_e"),
			(else_try),
				(create_mesh_overlay, reg5,"mesh_coins_f"),
			(else_try),

			(try_end),
			(position_set_x, pos0, 150),
			(position_set_y, pos0, 150),
			(overlay_set_size, reg5, pos0),
			(position_set_x, pos0, 320), ### pozycja ikonki monet po lewej
			(position_set_y, pos0, 290),
			(overlay_set_position, reg5, pos0),
		    (overlay_set_additional_render_height, reg5, 10),
			(try_begin),
				(neg|is_between, "$duel_troop2", BrawlersBegin, BrawlersEnd),
				(overlay_set_alpha, reg5, 0),
			(try_end),
			
			(store_troop_gold, reg0, "$duel_troop2"),
			(try_begin),
				(lt, reg0, 200),
				(create_mesh_overlay, reg5,"mesh_coins_a"),
			(else_try),
			...
			(position_set_y, pos0, 150),
			(overlay_set_size, reg5, pos0),
			(position_set_x, pos0, 570),### pozycja ikonki monet po prawej
			(position_set_y, pos0, 290),
			(overlay_set_position, reg5, pos0),		
			(try_begin),
				(neg|is_between, "$duel_troop2", BrawlersBegin, BrawlersEnd),
			...
			(create_text_overlay, reg1, s1),
			(position_set_x, pos1, 325), #pozycja tekstu lewego
			(position_set_y, pos1, 400),
			(overlay_set_position, reg1, pos1),
			(overlay_set_color, reg1, 0xFFFFFF),
			(try_begin),
			...
			(try_begin),
				(eq, "$duel_type", 1),
				(troop_get_slot, reg10, "$duel_troop2", BrawlerSwordRank),
			(else_try),
				(troop_get_slot, reg10, "$duel_troop2", BrawlerPistolRank),
			(try_end),
			(store_troop_gold, reg12, "$duel_troop2"),
			(str_store_string, s1, "@Pozycja: {reg10} ^Złoto: {reg12}"),
			
			(create_text_overlay, reg1, s1),
			(position_set_x, pos1, 570), #pozycja tekstu prawego
			(position_set_y, pos1, 400),
			(overlay_set_position, reg1, pos1),
			(overlay_set_color, reg1, 0xFFFFFF),
			(try_begin),
			...
			# (create_button_overlay, "$g_Rozpocznij", "@Rozpocznij"),
			# (position_set_x, pos1, 500), #pozycja przycisku startu
			# (position_set_y, pos1, 100),
			# (overlay_set_position, "$g_Rozpocznij", pos1),
			
			
			(create_image_button_overlay,"$g_Rozpocznij","mesh_ui_c","mesh_ui_c_selected"),
			(position_set_x, pos0, 400),#pozycja
			(position_set_y, pos0, 100),
			(overlay_set_position, "$g_Rozpocznij", pos0),
			(position_set_x, pos1, 1150),#wielkość
			(position_set_y, pos1, 800),
			(overlay_set_size, "$g_Rozpocznij", pos1),
			(overlay_set_additional_render_height, "$g_Rozpocznij", 9),

			(create_text_overlay, reg0, "@Rozpocznij."),
			(position_set_x, pos0, 455),#pozycja
			(position_set_y, pos0, 105),
			(overlay_set_position, reg0, pos0),
			(position_set_x, pos0, 1100),#wielkość
			(position_set_y, pos0, 1100),
			(overlay_set_size, reg0, pos0),
			...
			(create_text_overlay, reg1, "@Suma:"),
			(position_set_x, pos1, 455), #pozycja tekstu suma
			...
			(store_troop_gold, ":g1", "$duel_troop1"),
			(store_troop_gold, ":g2", "$duel_troop2"),
			...
			(try_begin),
				(eq, ":max", 0),
				(create_slider_overlay, "$g_Suma",0,0),
			(else_try),
				(create_slider_overlay, "$g_Suma",50,":max"),
			(try_end),
			(position_set_x, pos1, 510), #pozycja suwaku sumy 
			(position_set_y, pos1, 200),
			(overlay_set_position, "$g_Suma", pos1),
			(try_begin),
				(neg|is_between, "$duel_troop2", BrawlersBegin, BrawlersEnd),
				(overlay_set_alpha, "$g_Suma", 0),
			(try_end),
			
			(assign, "$duel_value", 50),
			(val_min, "$duel_value", ":max"),
			(assign, reg0, "$duel_value"),
			
			(create_text_overlay, "$g_Sumatext", "@{reg0}"),

			(position_set_x, pos1, 525), #pozycja tekstu suma 
			(position_set_y, pos1, 230),
			(overlay_set_position, "$g_Sumatext", pos1),
			(overlay_set_color, "$g_Sumatext", 0xFFFFFF),
			(try_begin),
				(neg|is_between, "$duel_troop2", BrawlersBegin, BrawlersEnd),
				(overlay_set_alpha, "$g_Sumatext", 0),
			(try_end),
			
			(play_track, "track_pojedynek",1),
			(presentation_set_duration, 99999999),
		]),
	(ti_on_presentation_event_state_change,[	  
		(store_trigger_param_1, ":object"),
		...
		(try_begin),
			(eq, ":object", "$g_Rozpocznij"),
			(assign, "$duel_next_round", 0),
		...
		(else_try),
		   (eq,":object","$g_Suma"),
		   (assign, reg1, ":value"),
		   (assign, "$duel_value",reg1),
		   (str_store_string, s1, "@{reg1}"),
		   (overlay_set_text, "$g_Sumatext", s1),
		(try_end),	
	...
	("drink",0, 0,[
		...
		[
			(set_fixed_point_multiplier, 1000),
			  ...
			  (create_mesh_overlay, "$Dialog", "mesh_white_plane"),
			  (overlay_set_color, "$Dialog", 0x000000),
			  (overlay_set_alpha, "$Dialog", 0x66),
			  (position_set_x, pos1, 0),
			  (position_set_y, pos1, -350),
			  (overlay_set_position, "$Dialog", pos1),
			  (position_set_x, pos1, 80000),
			  (position_set_y, pos1, 30000),
			  (overlay_set_size, "$Dialog", pos1),
			  
			  (create_mesh_overlay, "$PlayerDialog", "mesh_white_plane"),
			  (overlay_set_color, "$PlayerDialog", 0x000000),
			  (overlay_set_alpha, "$PlayerDialog", 0x66),
			  (position_set_x, pos1, 30000),
			  (position_set_y, pos1, 70000),
			  (overlay_set_size, "$PlayerDialog", pos1),
			  (position_set_x, pos1, 700),
			  (position_set_y, pos1, 200),
			  (overlay_set_position, "$PlayerDialog", pos1),
			  
			  # (create_mesh_overlay, "$EnemyDialog", "mesh_white_plane"),
			  # (overlay_set_color, "$EnemyDialog", 0x000000),
			  # (overlay_set_alpha, "$EnemyDialog", 0x66),
			  # (position_set_x, pos1, 30000),
			  # (position_set_y, pos1, 70000),
			  # (overlay_set_size, "$EnemyDialog", pos1),
			  # (position_set_x, pos1, -300),
			  # (position_set_y, pos1, 200),
			  # (overlay_set_position, "$EnemyDialog", pos1),
			  
			  (init_position, pos5),
			  (position_set_y, pos5, 300),
			  
			  (create_game_button_overlay, "$DrinkButtonDrink", "@Wypij"),
			  (overlay_set_position, "$DrinkButtonDrink", pos5),
			  # (init_position, pos4),
			  # (position_set_x, pos4, 300),
			  # (position_set_y, pos4, 300),
			  # (overlay_set_size, "$DrinkButtonDrink", pos4),
		...
		(ti_on_presentation_run,  [
			...
			(try_begin),
				(gt, ":time", 2000),
				(eq, "$DrinkCup", -1),
			    (1,"script_drinkFindNextCup", "spr_1794_drink_cup"),
			    (assign, "$DrinkCup", reg0),
			    
				(try_begin),
					(eq, "$DrinkCup", -1),
					(1,"script_drinkSpawnCups"),
				(else_try),
					(prop_instance_get_position, pos0, "$DrinkCup"),
					
					(init_position, pos2),
					(position_copy_rotation, pos0, pos2),

					(position_get_screen_projection, pos1, pos0),
					(position_move_y, pos1, -2, 0),
					(overlay_set_position, "$DrinkButtonDrink", pos1),
				(try_end),
			(try_end),
		]),
	  ...
	  (ti_on_presentation_event_state_change, [
			(store_trigger_param_1, ":object"),
			(try_begin),
				(eq, ":object", "$DrinkButtonDrink"),
				(scene_prop_set_slot, "$DrinkCup", 30, 1),
				(init_position, pos1),
				(position_set_z, pos1, -10000),
				(prop_instance_set_position, "$DrinkCup", pos1),
				(assign, "$DrinkCup", -1),
				
				(1,"script_drinkFindNextCup", "spr_1794_drink_cup2"),
				
				(scene_prop_set_slot, reg0, 30, 1),
...
("4quests",0,0,[
	...
	[
		...
		(assign, "$currentQuest", -1),
		(assign, "$g_talk_troop", "trp_player"),
		
		(troop_get_slot, ":ilosc", "trp_temp_array_a",1000),
		
		# (store_mul, ":cur_y", ":ilosc", 25),
		(assign, ":cur_y", 650),
		(init_position, pos0),
		(init_position, pos1),
		...
		(try_for_range, ":i", 0, ":ilosc"),
			(troop_get_slot, ":quest", "trp_temp_array_a",":i"),
			(quest_slot_eq, ":quest", DontGiveAgain+1, 0),
			(position_set_x, pos0, 50),
			(position_set_y, pos0, ":cur_y"),
			(str_store_quest_name, s2, ":quest"),
			...
			(troop_set_slot, "trp_temp_array_b", ":i", ":overlay"),
			(val_sub, ":cur_y", 25),
			(val_add, reg2, 1),
		(try_end),
		...
		(overlay_set_color, reg0, 0x000000),
		(overlay_set_alpha, reg0, 0x88),
		(position_set_x, pos1, 490),#pozycja
		(position_set_y, pos1, 550),
		(overlay_set_position, reg0, pos1),
		(position_set_x, pos1, 22000),#wielkość
		(position_set_y, pos1, 8000),
		(overlay_set_size, reg0, pos1),
		
		###############################################################################
		(create_text_overlay, reg0, "@Dostępne zadania"),
		(position_set_x, pos1, 1170), #50
		(position_set_y, pos1, 1170),#560
		(overlay_set_size, reg0, pos1),
		(position_set_x, pos1, 85), #50
		(position_set_y, pos1, 686),#560
		(overlay_set_position, reg0, pos1),
		(overlay_set_color, reg0, 0xFFFFFF),
		...
		(create_text_overlay, "$text_part", s1, tf_scrollable),
		(overlay_set_text, "$text_part", s1),
		(position_set_x, pos1, 585), #50
		(position_set_y, pos1, 370),#560
		(overlay_set_position, "$text_part", pos1),
		(str_store_string, s1, "@Nie wybrałeś żadnego zadania."),
		(overlay_set_text, "$text_part", s1),
		(position_set_x, pos1, 1000),
		(position_set_y, pos1, 1000),
		(overlay_set_size, "$text_part", pos1),
		(position_set_x, pos1, 300),
		(position_set_y, pos1, 300),
		(overlay_set_area_size, "$text_part", pos1),
		(overlay_set_color, "$text_part", 0xFFFFFF),
		...
		(create_image_button_overlay,"$accept","mesh_ui_c","mesh_ui_c_selected"),
		(position_set_x, pos0, 550),#pozycja
		(position_set_y, pos0, 30),
		(overlay_set_position, "$accept", pos0),
		(position_set_x, pos1, 900),#wielkość
		(position_set_y, pos1, 900),
		(overlay_set_size, "$accept", pos1),
		#
		(create_text_overlay, reg0, "@Przyjmij"),
		(position_set_x, pos0, 587),#pozycja
		(position_set_y, pos0, 36),
		(overlay_set_position, reg0, pos0),
		(position_set_x, pos0, 1300),#wielkość
		(position_set_y, pos0, 1300),
	...
	[
		...
		(else_try),
			...
			(try_begin),
				(neq, "$currentQuest", -1),
				(1,"script_2Etap_quest_start", "$currentQuest"),
				(assign, "$BreakPresentation", 1),
				(presentation_set_duration, 0),
				(finish_mission),
			(try_end),
		(else_try),
			...
			(try_for_range, ":i", 0, ":ilosc"),
				...
				(troop_get_slot, ":index","trp_temp_array_b",":i"),
				(overlay_set_color, ":index", 0xEEEEEE),
				
				(troop_slot_eq, "trp_temp_array_b", ":i", ":object"),
				
				(troop_get_slot, "$currentQuest", "trp_temp_array_a", ":i"),
				(overlay_set_color, ":object", 0xAAAAAA),
			(try_end),
			
			(quest_get_slot, ":str", "$currentQuest", SlotQuestDesc),
			(set_container_overlay, -1),
			(str_store_string, s1, ":str"),
			(overlay_set_text, "$text_part", s1),
			(init_position, pos0),
			(position_set_x, pos0, 510),
			(position_set_y, pos0, 400),
			(overlay_set_position, "$text_part", pos0),
		(try_end),
	]),
   ...
   [
     (ti_on_presentation_load,
	  ...
	  (try_for_range, ":town", towns_begin, towns_end),
		(party_slot_ge, ":town", TownRegionSize, 1),
		(call_script, "script_regionGetFaction", ":town"),
		(try_begin),
			(eq, ReturnValue, Kosciuszkowcy),
			(val_add, ":regions", 1),
		(else_try),
			(neq, ReturnValue, Kosciuszkowcy),
			(party_get_slot, ":original", ":town", slot_center_original_faction),
			(eq, ":original", Targowica),
			(val_sub, ":regions", 1),
		(try_end),
	  (try_end),
	  
	  (assign, reg0, ":regions"),
	  ]+debugMessage("@DEBUG: regions: {reg0}")+[
	  
	  (store_sub, ":max", "str_endgame_1", "str_endgame_last"),
	  (val_min, ":regions", ":max"),
	  (store_add, ":text", "str_endgame_1", ":regions"),
	  (val_max, ":text", "str_wyrok_1_4"),
	  
	  (str_store_string, s100, ":text"),
	  
	  (create_text_overlay, reg0, s100, tf_scrollable),
      (position_set_x, pos1, 1400),
      (position_set_y, pos1, 1400),
      (overlay_set_size, reg0, pos1),
