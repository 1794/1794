...
slot_town_castle        = 11
slot_town_prison        = 12
PartyOldHelpfulness     = 12
PartyOldAggresive       = 13
slot_town_tavern        = 13
slot_town_store         = 14
slot_town_arena         = 16
slot_town_alley         = 17
...
TownRegionActionMarker			  = 75
TownRegionLastOwner               = 76
TownRegionSize                    = 77
TownRegion						  = TownRegionSize+1
...
UciekinierDays									= 140
UciekinierType									= 141
UciekinierTarget								= 142

UciekinierType_WasClose 						= 1
UciekinierType_Been								= 2
UciekinierType_Is								= 3

UciekinierBlisko								= 10
UciekinierBylTutaj									= 12
UciekinierBylW									= 13
UciekinierJestW									= 13
...
slot_quest_target_amount            = 30
slot_quest_current_state            = 31
slot_quest_giver_center             = 32
slot_quest_target_dna               = 33
slot_quest_target_item              = 34
slot_quest_object_faction           = 35

slot_quest_target_state             = 36
...
active_npcs_begin = kings_begin
active_npcs_end = pretenders_begin
...
#Piss begin
Targowica = "fac_kingdom_1"
Rosja = "fac_kingdom_2"
Prusy = "fac_kingdom_3"
Austria = "fac_kingdom_4"

Kosciuszkowcy = "fac_kingdom_5"

slot_faction_pomniejsza						 			= 170
FactionWaves											= 170
poczatkowa_ilosc_lenn						 			= 171
FactionGuard								 			= 172
DiplBegin												= 300

#Piss end 

duel_scenes_begin = "scn_duel_1"
duel_scenes_end = "scn_field_1"

regular_troop_begin = "trp_kosynier"
regular_troop_end = "trp_austrian_mounted_guards_officer"

bankers_begin = "trp_town_1_banker"
bankers_end = "trp_town_banker_end"

town_interrior_scenes_begin = "scn_town_1_castle"
town_interrior_scenes_end = "scn_town_22_castle"

kosciuszkowcy_begin = "trp_knight_1_1"
kosciuszkowcy_end = "trp_knight_1_20"
...
polish_fusiliers_set_begin = "itm_polish_fusiliers_uniform"
polish_fusiliers_set_end   = "itm_polish_fusiliers_end"

polish_national_cavalry_set_begin = "itm_polish_national_cavalry_uniform"
polish_national_cavalry_set_end   = "itm_polish_national_cavalry_end"

rusian_huzar_set_begin = "itm_russian_huzar_uniform"
russian_huzar_set_end   = "itm_russian_huzar_end"

werbownik_begin = "trp_werbownik_a"
werbownik_end   = "trp_werbownik_end"

AllSoldiersBegin = "trp_golota"
AllSoldiersEnd = "trp_zendar_chest"
#-----------------------------
...
DuelScorePistol								= 418
DuelScoreSword								= 419
TroopDialogLevel						= 420
TroopAdditionalCost						= 421
TroopName								= 422
TroopSurname							= 423
TroopOrigin								= 425
BoundLocation							= 424
BrawlerPistolWins						= 427
BrawlerPistolLoses						= 428
BrawlerPistolRank						= 429
BrawlerSwordWins						= 430
BrawlerSwordLoses						= 431
BrawlerSwordRank						= 432



SlotPartyBrawler						= 403
SlotPartyBanker							= 404
SlotPartyFaction		= 405
SlotTownBrawler = SlotPartyBrawler
DniOdPrzejeciaPrzezKosciuszkowcow								= 410
SlotSecondFaction				= 411
MercenaryName					= 412
MercenaryArms = 413
MercenaryLand = 414
MercenaryReason = 415
slot_castle_siege = 416
SiegeState	= 417
TownSzpieg = 418
SiegeSabotageScene = 419
BramaWysadzona = 420
KarczmaLowca = 421
KarczmaDziad = 422
PartyHasExecution = 422
ExecutionMarker = 421
TavernOpponents = 420
Town4Etap = 425
Town4EtapBonus = 426
PatrolCenter = SlotPartyBrawler
PatrolType = SlotPartyBanker
TownCitizen1		= 1001
TownCitizen40		= 1040
TownCitizensBegin = TownCitizen1
CitizensNum = 90
TownCitizensEnd = TownCitizen1 + CitizensNum

SpeechEmisariusz = "trp_qrozpoznanieogniemt1"
SpeechZolnierz = "trp_austrian_executioner"
...
SlotFactionDefeatChance = 200
SlotFactionVillages = 201
SlotFactionCastles = 202
SlotFactionTowns = 203

CSlotFactionVillages = 204
CSlotFactionCastles = 205
CSlotFactionTowns = 206

PatrolMilicja = 230
PatrolPiechota = 231
PatrolKawaleria = 232
PatrolMilicjaLeader = 234
PatrolPiechotaLeader = 235
PatrolKawaleriaLeader = 236

TakenFromTargowica = 233
LeaderName = 233
LeaderSurname = 234
LeaderNameFormat = 235
BanditDestination = 236
...
SpeechLineTime = 6
SpeechTextBegin = 6
SpeechTextEnd = SpeechTextBegin+SpeechLineTime*3
...
BattleData = "itm_battle_data"
TacticCallback = "trp_tournament_participants"
TacticAI = "trp_tutorial_maceman"
TacticPlayer = "trp_tutorial_archer"

############################################
#Tactic's callback info
Tactic_Offensive 	= 0x001
Tactic_Defensive    = 0x002
# Tactic_Balance		= 0x004

Tactic_EnemyFar		= 0x010
Tactic_EnemyNear	= 0x020

############################################
Formation_Line   = 1
Formation_Square = 2
Formation_Tyralery = 3

Formation_FixedPoint = 10000

Formation_Offset = int(1.75*Formation_FixedPoint)
Tyralery_OffsetX  = int(2*Formation_FixedPoint)
Tyralery_OffsetY  = int(2*Formation_FixedPoint)
Line_Row_Offset   = int(0.5*Formation_FixedPoint)
...
TopicsBegin = "qst_topic1"
TopicsEnd = "qst_topics_end"

BrawlersBegin = "trp_brawler_1_a"
BrawlersEnd   = "trp_brawler_end"

SzlachtaComplainBegin = "str_weather_complain_1_1"
SzlachtaComplainEnd = "str_weather_complain_2_1"
SzlachtaFComplainBegin = "str_weather_complain_2_1"
SzlachtaFComplainEnd = "str_weather_complain_3_1"

MieszczanstwoComplainBegin = "str_weather_complain_3_1"
MieszczanstwoComplainEnd = "str_weather_complain_4_1"
MieszczanstwoFComplainBegin = "str_weather_complain_4_1"
MieszczanstwoFComplainEnd = "str_weather_complain_5_1"

BiedotaComplainBegin = "str_weather_complain_5_1"
BiedotaComplainEnd = "str_weather_complain_end"

SzlachtaGreetingBegin = "str_greeting_1_1"
SzlachtaGreetingEnd = "str_greeting_2_1"
SzlachtaFGreetingBegin = "str_greeting_2_1"
SzlachtaFGreetingEnd = "str_greeting_3_1"

MieszczanstwoGreetingBegin = "str_greeting_3_1"
MieszczanstwoGreetingEnd = "str_greeting_4_1"
MieszczanstwoFGreetingBegin = "str_greeting_4_1"
MieszczanstwoFGreetingEnd = "str_greeting_5_1"

BiedotaGreetingBegin = "str_greeting_5_1"
BiedotaGreetingEnd = "str_greeting_end"


SoldiersBegin = "trp_lithuania_rifleman"
SoldiersEnd = "trp_cossack_veteran"

RumorType_Normal = 0
RumorType_Special = 1

RumorActive = "itm_rumor_active"
RumorType = "itm_rumor_type"
RumorString = "itm_rumor_string"
RumorTown = "itm_rumor_town"
RumorTroop = "itm_rumor_troop"
RumorStartDay = "itm_rumor_sday"
RumorStartMonth = "itm_rumor_smonth"
RumorStartYear = "itm_rumor_syear"
RumorEndDay = "itm_rumor_eday"
RumorEndMonth = "itm_rumor_emonth"
RumorEndYear = "itm_rumor_eyear"
RumorFaction = "itm_rumor_faction"
RumorScript = "itm_rumor_script"

Execution_Normal = 0
Execution_Civilian = 1


Manifest_Opponents = 1
Uniwersal_Opponents = 3

Manifest_Locations = 2
Uniwersal_Locations = 3



TalkLineTime = 3

QuestProgressColor = 0x157DEC

MessageBoxYesNo		= 0x00000002
MessageBoxInfo		= 0x00000004
MessageBoxSlider	= 0x00000020
MessageBoxLock		= 0x00000040


FormationType			= 0
FormationRefresh		= 10
FormationCrouch			= 40
FormationCrouchRefresh	= 50
FormationStandingAgents = 60
FormationNoAutoCrouch		= 70


BanditTemplateLimit = 25

AgentTextLimit 			= 10

AustriaAttackLimit = 40
...
def debugMessage(x, color=0xFFFFFF):
	return [(try_begin),(ge, "$_DEBUG", 1),(display_message, x, color),(try_end),]
