...
map_icons = [
  ...
  ("village_snow_burnt_a",mcn_no_shadow,"wiejska_parafia", 0.45, 0),#wiejska_parafia
  ("village_snow_deserted_a",mcn_no_shadow,"oboz", 0.45, 0),

  ("camp",mcn_no_shadow,"oboz_a", 0.13, 0),
  ...
  ("town_ikona",mcn_no_shadow,"ikona", 0.35,0),
  ...
  ("map_marker",mcn_no_shadow,"manifest", 0.45, 0),
  ("map_marker2",mcn_no_shadow,"map_marker", 0.45, 0),
  ("manifest",mcn_no_shadow,"manifest", 0.45, 0),
  ("map_windmill",mcn_no_shadow,"map_windmill", 0.13, 0),
]
