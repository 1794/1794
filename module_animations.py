...
#  [35.0, "tavern_stand", 0, 472, arf_cyclic|arf_loop_pos_0_25],
 ...
 #[5.5, "stand_a", 0, 79, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
...
##   [0.8, "jump_end_hard", 29, 54, arf_blend_in_1],
 ...
 ["stand_single", 0, amf_client_prediction,
    [5.0, "pistol_stance", 0, 99, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
...
#   [4.0, "musket_cstance_new", 0, 99, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],  
   [5.0, "musket_hold", 0, 59, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],  
 ],
...
#   [0.95, "turn_man_staff", 30, 50, arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
  ...
  ["turn_right_staff", acf_enforce_lowerbody, amf_play|amf_client_prediction,
   [0.95, "musket_turn", 0, 20, arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
 ],
 ["turn_left_staff", acf_enforce_lowerbody, amf_play|amf_client_prediction,
   [0.95, "musket_turn", 30, 50, arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
 ],
...
##   [0.8, "run_greatsword", 0, 22, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0], 
   [0.8, "musket_run_forward", 0, 24, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
 ],
...
##   [0.8, "run_crossleft_staff", 0, 24, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
   [0.8, "musket_run_forward_left", 0, 24, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
 ],
...
#   [1.0, "anim_human", 7140, 7100, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [0.7, "musket_run_backward", 0, 21, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4],
 ],
...
#   [1.0, "anim_human", 7140, 7100, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [0.7, "musket_run_backward_right", 0, 21, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4],
 ],
...
#   [1.0, "anim_human", 7140, 7100, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [0.7, "musket_run_backward_left", 0, 21, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4],
 ],
...
##   [0.8, "run_right_staff", 0, 24, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0], 
   [0.8, "musket_run_right", 0, 24, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0], 
 ],
...
##   [0.8, "run_left_staff", 0, 24, arf_use_walk_progress|arf_cyclic|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],  
   [0.8, "musket_run_left", 0, 24, arf_use_walk_progress|arf_cyclic|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],  
 ],
...
["walk_right", acf_enforce_lowerbody, amf_use_cycle_period|amf_client_prediction,
 ...
 ["walk_forward_crouch", acf_enforce_lowerbody, amf_play|amf_client_prediction|amf_priority_equip,
   #[1.7, "low_walk", 0, 48, arf_blend_in_5],#arf_use_walk_progress|arf_cyclic,pack2f(0.4,0.9)
   [4.0, "stand_to_kneel", 30, 100,  arf_cyclic|arf_blend_in_5],
 ],
 ["stand_to_crouch", acf_enforce_lowerbody, amf_play|amf_priority_mount,
   [4.0, "stand_to_kneel", 0, 30,  arf_blend_in_5],
 # ["kneel", acf_enforce_lowerbody, amf_play|amf_priority_mount,
   # [4.0, "stand_to_kneel", 30, 90,  arf_blend_in_5],
  ],
  
 ["crouch_to_stand", acf_enforce_lowerbody, amf_priority_equip+1,
...
# ],
    ["lancer_ride_4_no_shield",  acf_enforce_lowerbody |  acf_rot_vertical_sword, amf_rider_rot_couched_lance|amf_client_prediction|amf_priority_ride|amf_play,
...
# duration and controlled via weapon speed.
 ...
 ["ready_crossbow", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_keep|amf_client_owner_prediction|amf_rider_rot_crossbow,
   [1.2, "musket_ani", 499, 599, blend_in_ready],
 ],
 ["release_crossbow", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_play|amf_client_owner_prediction|amf_rider_rot_crossbow,
   [0.5, "musket_ani", 599, 629, arf_blend_in_1],
 ],
 ["reload_crossbow", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
   [7.0, "musket_ani", 1, 485, blend_in_ready], 
 ],
...
##   [1.0, "throw_stone", 21, 54, arf_blend_in_0],
 ...
 ["ready_pistol", acf_rot_vertical_sword|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_rider_rot_pistol,
  [0.4, "anim_human", combat+2500, combat+2515, arf_blend_in_8],
 ],
...
["duel_stance", 0, amf_play|amf_start_instantly,
[5.0, "duel_stance", 0, 99, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
],
["dial_a", 0, amf_priority_striked|amf_play|amf_start_instantly,
[2.0, "dial_a", 0, 50, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
],
["dial_b", 0, amf_priority_striked|amf_play|amf_start_instantly,
[2.25, "dial_b", 0, 63, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
],
 ...
 ["reset", 0, amf_priority_striked|amf_use_weapon_speed|amf_play,
   [0.1, "parry_single_lefttoright", 0, 75, blend_in_parry], 
 ],
["sit", 0, amf_priority_striked|amf_play|amf_start_instantly|amf_keep,
[2.0, "sit_test", 0, 50, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
],
 ]
