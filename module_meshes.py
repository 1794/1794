...
meshes = [
  ("pic_bandits", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_mb_warrior_1", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_messenger", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_prisoner_man", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_prisoner_fem", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_prisoner_wilderness", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_siege_sighted", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_siege_sighted_fem", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_camp", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_payment", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_escape_1", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_escape_1_fem", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_victory", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_defeat", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_wounded", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_wounded_fem", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_steppe_bandits", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_mountain_bandits", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_sea_raiders", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_deserters", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_forest_bandits", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_cattle", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_looted_village", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_village_p", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_village_s", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_village_w", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_recruits", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_arms_swadian", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_arms_vaegir", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_arms_khergit", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_arms_nord", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_arms_rhodok", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_sarranid_arms", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_castle1", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_castledes", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_castlesnow", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_charge", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_khergit", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_nord", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_rhodock", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_sally_out", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_siege_attack", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_swad", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_town1", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_towndes", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_townriot", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_townsnow", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_vaegir", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_villageriot", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("pic_sarranid_encounter", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ...
  ("flag_projects_end", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ...
  ("flag_project_misses_end", 0, "1794_nic", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ...
  ("damage", 0, "damage", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("damage_a", 0, "damage_a", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ...
  ("herb", 0, "herb", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("money", 0, "pieniadze", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("drzewko", 0, "drzewko", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("oznacznik", 0, "drzewko_oznacznik", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("button_a", 0, "button_a", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("button_b", 0, "button_b", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("button_c", 0, "button_c", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("recback", 0, "tlo", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("papier", 0, "papier", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("list", 0, "list", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("bg3", 0, "bg3", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("bg4", 0, "bg4", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("bg5", 0, "bg5", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("bg6", 0, "bg6", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("bg7", 0, "bg7", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  
  ("ui_a", 0, "ui_a", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("ui_b", 0, "ui_b", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("ui_c", 0, "ui_c", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("ui_c_selected", 0, "ui_c_selected", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("ui_d", 0, "ui_d", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("ui_e", 0, "ui_e", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("ui_f", 0, "ui_f", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("ui_g", 0, "ui_g", 0, 0, 0, 0, 0, 0, 1, 1, 1),
	
  ("coins_a", 0, "coins_a", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("coins_b", 0, "coins_b", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("coins_c", 0, "coins_c", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("coins_d", 0, "coins_d", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("coins_e", 0, "coins_e", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("coins_f", 0, "coins_f", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  
  ("dial_background", 0, "dial_background", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("dial_button_a", 0, "dial_button_a", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("dial_slider", 0, "dial_button_b", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("main_menu_nord", 0, "main_menu_nord", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  
  ("tree_arm1", 0, "oznaczone_a", 0, 0, 0, 180, 0, 0, 1, 1, 1),
  ("tree_arm2", 0, "oznaczone_b", 0, 0, 0, 180, 0, 0, 1, 1, 1),
  ("tree_arm3", 0, "oznaczone_c", 0, 0, 0, 180, 0, 0, 1, 1, 1),
]
